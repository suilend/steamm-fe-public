...
export default function SearchDialog() {
  ...
  return (
    <Dialog
      ...
      trigger={
        md ? (
          <button className="group flex h-10 w-max flex-row items-center justify-between gap-4 rounded-md border px-3 focus-visible:outline focus-visible:outline-focus">
            ...
            <div className="relative flex h-16 w-full shrink-0 flex-row items-center">
              ...
              <input
                ...
                style={{
                  ...
                  paddingRight: (rawSearchString !== "" ? 2.5 + 5 + 5 : 5) * 4,
                }}
              />
            </div>
            <Divider />
