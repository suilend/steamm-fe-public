            ...
            >
              {isSubmitting ? (
                <div className="flex items-center justify-center">
                  <div className="border-t-transparent rounded-full mr-2 h-4 w-4 animate-spin border-2 border-background"></div>
                  <span>Creating...</span>
                </div>
              ) : (
                "Create Token"
      ...
      <div className="space-y-4 px-1 py-2">
        <div className="space-y-3">
          {tokenParams.iconUrl && (
            <div className="flex flex-col items-center justify-center pb-2">
              <img
                ...
                alt="Token icon"
                className="rounded-full h-16 w-16 border object-contain"
              />
            </div>
          )}
          ...
          <div className="flex flex-col justify-between gap-1 pb-1 sm:flex-row sm:items-center sm:gap-2">
            ...
            <span className="text-foreground">{tokenParams.tokenSymbol}</span>
          </div>
          ...
          <div className="flex flex-col justify-between gap-1 pb-1 sm:flex-row sm:items-center sm:gap-2">
            ...
            <span className="text-foreground">{tokenParams.tokenDecimals}</span>
          </div>

          {tokenParams.tokenDescription && (
            <div className="flex flex-col justify-between gap-1 pb-1">
              <span className="text-muted-foreground text-sm font-medium">
                Description
              </span>
