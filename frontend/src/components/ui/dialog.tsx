...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-2 z-50 flex flex-col items-center data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 md:inset-8 md:justify-center",
        className,
      )}
      {...props}
    >
