    ...
    static reified(): CharReified {
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                Char.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Char.fetch(
                client,
                id,
            ),
            new: (
...
export class String implements StructClass {
    ...
    static reified(): StringReified {
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                String.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => String.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return String.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return String.fromSuiObjectData(
            res.data
        );
    }
}
