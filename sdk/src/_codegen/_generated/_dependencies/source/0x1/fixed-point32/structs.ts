...
export class FixedPoint32 implements StructClass {
    ...
    static reified(): FixedPoint32Reified {
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                FixedPoint32.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => FixedPoint32.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return FixedPoint32.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return FixedPoint32.fromSuiObjectData(
            res.data
        );
    }
}
