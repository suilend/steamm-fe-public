...
export type UQ32_32Reified = Reified<
    UQ32_32,
    UQ32_32Fields
>;
...
export class UQ32_32 implements StructClass {
    ...
    static fromBcs(
        ...
        return UQ32_32.fromFields(
            UQ32_32.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return UQ32_32.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return UQ32_32.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UQ32_32.fromSuiObjectData(
            res.data
        );
    }
}
