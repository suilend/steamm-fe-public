...
export type UQ64_64Reified = Reified<
    UQ64_64,
    UQ64_64Fields
>;
...
export class UQ64_64 implements StructClass {
    ...
    static reified(): UQ64_64Reified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                UQ64_64.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                UQ64_64.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => UQ64_64.fetch(
                client,
                id,
            ),
            new: (
                fields: UQ64_64Fields,
            ) => {
                return new UQ64_64(
                    [],
                    fields
    ...
    static fromBcs(
        ...
        return UQ64_64.fromFields(
            UQ64_64.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return UQ64_64.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return UQ64_64.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return UQ64_64.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UQ64_64.fromSuiObjectData(
            res.data
        );
    }
}
