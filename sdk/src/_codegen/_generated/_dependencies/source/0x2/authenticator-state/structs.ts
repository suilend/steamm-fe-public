...
export class ActiveJwk implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ActiveJwk.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ActiveJwk.fromSuiObjectData(
            res.data
        );
    }
}
...
export class AuthenticatorState implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return AuthenticatorState.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return AuthenticatorState.fromSuiObjectData(
            res.data
        );
    }
}
...
export class AuthenticatorStateInner implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return AuthenticatorStateInner.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return AuthenticatorStateInner.fromSuiObjectData(
            res.data
        );
    }
}
...
export class JwkId implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return JwkId.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return JwkId.fromSuiObjectData(
            res.data
        );
    }
}
