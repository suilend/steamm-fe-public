...
export class Balance<T extends PhantomTypeArgument> implements StructClass {
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return Balance.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Balance.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class Supply<T extends PhantomTypeArgument> implements StructClass {
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return Supply.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Supply.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
