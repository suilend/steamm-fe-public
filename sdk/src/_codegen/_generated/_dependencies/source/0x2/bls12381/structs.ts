...
export class Scalar implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Scalar.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Scalar.fromSuiObjectData(
            res.data
        );
    }
}
...
export class UncompressedG1 implements StructClass {
    ...
    static reified(): UncompressedG1Reified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                UncompressedG1.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                UncompressedG1.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                UncompressedG1.fromBcs(
                    data,
                ),
            bcs: UncompressedG1.bcs,
            fromJSONField: (field: any) =>
                UncompressedG1.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                UncompressedG1.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                UncompressedG1.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: UncompressedG1Fields,
            ) => {
                return new UncompressedG1(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return UncompressedG1.fromFields(
            UncompressedG1.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return UncompressedG1.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return UncompressedG1.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return UncompressedG1.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UncompressedG1.fromSuiObjectData(
            res.data
        );
    }
}
