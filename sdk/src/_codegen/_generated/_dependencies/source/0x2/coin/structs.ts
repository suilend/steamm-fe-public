...
export class CoinMetadata<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                CoinMetadata.fromSuiObjectData(
                    T,
                    content,
                ),
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return CoinMetadata.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return CoinMetadata.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class CurrencyCreated<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                CurrencyCreated.fromSuiObjectData(
                    T,
                    content,
                ),
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return CurrencyCreated.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return CurrencyCreated.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class DenyCap<T extends PhantomTypeArgument> implements StructClass {
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return DenyCap.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DenyCap.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export interface DenyCapV2Fields<T extends PhantomTypeArgument> {
    id: ToField<UID>; allowGlobalPause: ToField<"bool">
}
...
export class DenyCapV2<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            reifiedTypeArgs: [T],
            fromFields: (fields: Record<string, any>) =>
                DenyCapV2.fromFields(
                    T,
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                DenyCapV2.fromFieldsWithTypes(
                    T,
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                DenyCapV2.fromSuiParsedData(
                    T,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                DenyCapV2.fromSuiObjectData(
                    T,
                    content,
                ),
            ...
            new: (
                fields: DenyCapV2Fields<ToPhantomTypeArgument<T>>,
            ) => {
    ...
    static phantom<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return phantom(DenyCapV2.reified(
            T
        ));
    }
    ...
    static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DenyCapV2.reified(
            ...
            {id: decodeFromFields(UID.reified(), fields.id), allowGlobalPause: decodeFromFields("bool", fields.allow_global_pause)}
        )
    }
    ...
    static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DenyCapV2.reified(
            ...
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), allowGlobalPause: decodeFromFieldsWithTypes("bool", item.fields.allow_global_pause)}
        )
    }
    ...
    static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DenyCapV2.fromFields(
            typeArg,
            DenyCapV2.bcs.parse(data)
        )
    }
    ...
    static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DenyCapV2.reified(
            ...
            {id: decodeFromJSONField(UID.reified(), field.id), allowGlobalPause: decodeFromJSONField("bool", field.allowGlobalPause)}
        )
    }
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(DenyCapV2.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return DenyCapV2.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DenyCapV2.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return DenyCapV2.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DenyCapV2.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class RegulatedCoinMetadata<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                RegulatedCoinMetadata.fromSuiObjectData(
                    T,
                    content,
                ),
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return RegulatedCoinMetadata.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return RegulatedCoinMetadata.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class TreasuryCap<T extends PhantomTypeArgument> implements StructClass {
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return TreasuryCap.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return TreasuryCap.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
