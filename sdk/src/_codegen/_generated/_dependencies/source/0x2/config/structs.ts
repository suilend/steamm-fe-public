...
export class Config<WriteCap extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            typeArgs: [
                extractType(WriteCap)
            ] as [PhantomToTypeStr<ToPhantomTypeArgument<WriteCap>>],
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Config.fromSuiParsedData(
                    WriteCap,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Config.fromSuiObjectData(
                    WriteCap,
                    content,
                ),
            ...
            new: (
                fields: ConfigFields<ToPhantomTypeArgument<WriteCap>>,
            ) => {
                return new Config(
                    [extractType(WriteCap)],
                    fields
    ...
    static fromFields<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        typeArg: WriteCap, fields: Record<string, any>
    ...
    static fromFieldsWithTypes<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        typeArg: WriteCap, item: FieldsWithTypes
    ): Config<ToPhantomTypeArgument<WriteCap>> {
    ...
    static fromBcs<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        typeArg: WriteCap, data: Uint8Array
    ): Config<ToPhantomTypeArgument<WriteCap>> {

        return Config.fromFields(
            typeArg,
            Config.bcs.parse(data)
        )
    }
    ...
    static fromJSON<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        typeArg: WriteCap, json: Record<string, any>
    ): Config<ToPhantomTypeArgument<WriteCap>> {
        if (json.$typeName !== Config.$typeName) {
            throw new Error("not a WithTwoGenerics json object")
        };
        assertReifiedTypeArgsMatch(
            composeSuiType(Config.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return Config.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        typeArg: WriteCap, content: SuiParsedData
    ): Config<ToPhantomTypeArgument<WriteCap>> {
        ...
        return Config.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        typeArg: WriteCap, data: SuiObjectData
    ): Config<ToPhantomTypeArgument<WriteCap>> {
        if (data.bcs) {
        ...
        if (data.content) {
            return Config.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<WriteCap extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Config.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class Setting<Value extends TypeArgument> implements StructClass {
    ...
    readonly data:
        ToField<Option<SettingData<Value>>>
    ...
    static reified<Value extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            typeArgs: [
                extractType(Value)
            ] as [ToTypeStr<ToTypeArgument<Value>>],
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Setting.fromSuiParsedData(
                    Value,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Setting.fromSuiObjectData(
                    Value,
                    content,
                ),
            ...
            new: (
                fields: SettingFields<ToTypeArgument<Value>>,
            ) => {
                return new Setting(
                    [extractType(Value)],
                    fields
    ...
    static phantom<Value extends Reified<TypeArgument, any>>(
        ...
        return phantom(Setting.reified(
            Value
        ));
    }
    ...
    static get bcs() {
        return <Value extends BcsType<any>>(Value: Value) => bcs.struct(`Setting<${Value.name}>`, {
            data:
                Option.bcs(SettingData.bcs(Value))

        })
    };

    static fromFields<Value extends Reified<TypeArgument, any>>(
        typeArg: Value, fields: Record<string, any>
    ...
    static fromFieldsWithTypes<Value extends Reified<TypeArgument, any>>(
        typeArg: Value, item: FieldsWithTypes
    ): Setting<ToTypeArgument<Value>> {
    ...
    static fromJSON<Value extends Reified<TypeArgument, any>>(
        typeArg: Value, json: Record<string, any>
    ): Setting<ToTypeArgument<Value>> {
        if (json.$typeName !== Setting.$typeName) {
            throw new Error("not a WithTwoGenerics json object")
        };
        assertReifiedTypeArgsMatch(
            composeSuiType(Setting.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return Setting.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<Value extends Reified<TypeArgument, any>>(
        typeArg: Value, content: SuiParsedData
    ): Setting<ToTypeArgument<Value>> {
        if (content.dataType !== "moveObject") {
            throw new Error("not an object");
        }
        ...
        return Setting.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<Value extends Reified<TypeArgument, any>>(
        typeArg: Value, data: SuiObjectData
    ): Setting<ToTypeArgument<Value>> {
        if (data.bcs) {
        ...
        if (data.content) {
            return Setting.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<Value extends Reified<TypeArgument, any>>(
        ...
        return Setting.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export interface SettingDataFields<Value extends TypeArgument> {
    newerValueEpoch: ToField<"u64">; newerValue: ToField<Option<Value>>; olderValueOpt: ToField<Option<Value>>
}
...
export class SettingData<Value extends TypeArgument> implements StructClass {
    ...
    readonly newerValueEpoch:
        ToField<"u64">
    ; readonly newerValue:
        ToField<Option<Value>>
    ; readonly olderValueOpt:
        ToField<Option<Value>>
    ...
    static reified<Value extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            reifiedTypeArgs: [Value],
            fromFields: (fields: Record<string, any>) =>
                SettingData.fromFields(
                    Value,
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                SettingData.fromFieldsWithTypes(
                    Value,
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                SettingData.fromSuiParsedData(
                    Value,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                SettingData.fromSuiObjectData(
                    Value,
                    content,
                ),
            ...
            new: (
                fields: SettingDataFields<ToTypeArgument<Value>>,
            ) => {
    ...
    static phantom<Value extends Reified<TypeArgument, any>>(
        ...
        return phantom(SettingData.reified(
            Value
        ));
    }
    ...
    static fromFields<Value extends Reified<TypeArgument, any>>(
        ...
        return SettingData.reified(
            ...
            {newerValueEpoch: decodeFromFields("u64", fields.newer_value_epoch), newerValue: decodeFromFields(Option.reified(typeArg), fields.newer_value), olderValueOpt: decodeFromFields(Option.reified(typeArg), fields.older_value_opt)}
        )
    }
    ...
    static fromFieldsWithTypes<Value extends Reified<TypeArgument, any>>(
        ...
        return SettingData.reified(
            ...
            {newerValueEpoch: decodeFromFieldsWithTypes("u64", item.fields.newer_value_epoch), newerValue: decodeFromFieldsWithTypes(Option.reified(typeArg), item.fields.newer_value), olderValueOpt: decodeFromFieldsWithTypes(Option.reified(typeArg), item.fields.older_value_opt)}
        )
    }
    ...
    static fromJSONField<Value extends Reified<TypeArgument, any>>(
        ...
        return SettingData.reified(
            ...
            {newerValueEpoch: decodeFromJSONField("u64", field.newerValueEpoch), newerValue: decodeFromJSONField(Option.reified(typeArg), field.newerValue), olderValueOpt: decodeFromJSONField(Option.reified(typeArg), field.olderValueOpt)}
        )
    }
    ...
    static fromJSON<Value extends Reified<TypeArgument, any>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(SettingData.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return SettingData.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<Value extends Reified<TypeArgument, any>>(
        ...
        return SettingData.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<Value extends Reified<TypeArgument, any>>(
        ...
        if (data.content) {
            return SettingData.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<Value extends Reified<TypeArgument, any>>(
        ...
        return SettingData.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
