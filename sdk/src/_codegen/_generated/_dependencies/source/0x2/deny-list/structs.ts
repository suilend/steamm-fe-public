...
export type AddressKeyReified = Reified<
    AddressKey,
    AddressKeyFields
>;
...
export class AddressKey implements StructClass {
    ...
    static reified(): AddressKeyReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                AddressKey.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                AddressKey.fromFieldsWithTypes(
                    item,
                ),
    ...
    static fromBcs(
        ...
        return AddressKey.fromFields(
            AddressKey.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return AddressKey.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return AddressKey.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return AddressKey.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return AddressKey.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface ConfigKeyFields {
    perTypeIndex: ToField<"u64">; perTypeKey: ToField<Vector<"u8">>
}

export type ConfigKeyReified = Reified<
    ConfigKey,
    ConfigKeyFields
>;
...
export class ConfigKey implements StructClass {
    ...
    static reified(): ConfigKeyReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                ConfigKey.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                ConfigKey.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                ConfigKey.fromBcs(
    ...
    static fromFields(
        ...
        return ConfigKey.reified().new(
            {perTypeIndex: decodeFromFields("u64", fields.per_type_index), perTypeKey: decodeFromFields(reified.vector("u8"), fields.per_type_key)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return ConfigKey.reified().new(
            {perTypeIndex: decodeFromFieldsWithTypes("u64", item.fields.per_type_index), perTypeKey: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.per_type_key)}
        )
    }
    ...
    static fromBcs(
        ...
        return ConfigKey.fromFields(
            ConfigKey.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return ConfigKey.reified().new(
            {perTypeIndex: decodeFromJSONField("u64", field.perTypeIndex), perTypeKey: decodeFromJSONField(reified.vector("u8"), field.perTypeKey)}
        )
    }
    ...
    static fromJSON(
        ...
        return ConfigKey.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return ConfigKey.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ConfigKey.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ConfigKey.fromSuiObjectData(
            res.data
        );
    }
}
...
export class ConfigWriteCap implements StructClass {
    ...
    static reified(): ConfigWriteCapReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                ConfigWriteCap.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                ConfigWriteCap.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                ConfigWriteCap.fromBcs(
                    data,
                ),
            bcs: ConfigWriteCap.bcs,
            fromJSONField: (field: any) =>
                ConfigWriteCap.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                ConfigWriteCap.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                ConfigWriteCap.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: ConfigWriteCapFields,
            ) => {
                return new ConfigWriteCap(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return ConfigWriteCap.fromFields(
            ConfigWriteCap.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return ConfigWriteCap.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return ConfigWriteCap.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ConfigWriteCap.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ConfigWriteCap.fromSuiObjectData(
            res.data
        );
    }
}
...
export class DenyList implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return DenyList.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return DenyList.fromSuiObjectData(
            res.data
        );
    }
}
...
export class GlobalPauseKey implements StructClass {
    ...
    static reified(): GlobalPauseKeyReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                GlobalPauseKey.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GlobalPauseKey.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GlobalPauseKey.fromBcs(
                    data,
                ),
            bcs: GlobalPauseKey.bcs,
            fromJSONField: (field: any) =>
                GlobalPauseKey.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GlobalPauseKey.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GlobalPauseKey.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: GlobalPauseKeyFields,
            ) => {
                return new GlobalPauseKey(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return GlobalPauseKey.fromFields(
            GlobalPauseKey.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return GlobalPauseKey.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GlobalPauseKey.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GlobalPauseKey.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GlobalPauseKey.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface PerTypeConfigCreatedFields {
    key: ToField<ConfigKey>; configId: ToField<ID>
}
...
export class PerTypeConfigCreated implements StructClass {
    ...
    static reified(): PerTypeConfigCreatedReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                PerTypeConfigCreated.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PerTypeConfigCreated.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                PerTypeConfigCreated.fromBcs(
                    data,
                ),
            bcs: PerTypeConfigCreated.bcs,
            fromJSONField: (field: any) =>
                PerTypeConfigCreated.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PerTypeConfigCreated.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PerTypeConfigCreated.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: PerTypeConfigCreatedFields,
            ) => {
                return new PerTypeConfigCreated(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return PerTypeConfigCreated.reified().new(
            {key: decodeFromFields(ConfigKey.reified(), fields.key), configId: decodeFromFields(ID.reified(), fields.config_id)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return PerTypeConfigCreated.reified().new(
            {key: decodeFromFieldsWithTypes(ConfigKey.reified(), item.fields.key), configId: decodeFromFieldsWithTypes(ID.reified(), item.fields.config_id)}
        )
    }
    ...
    static fromJSONField(
        ...
        return PerTypeConfigCreated.reified().new(
            {key: decodeFromJSONField(ConfigKey.reified(), field.key), configId: decodeFromJSONField(ID.reified(), field.configId)}
        )
    }
    ...
    static fromJSON(
        ...
        return PerTypeConfigCreated.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PerTypeConfigCreated.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PerTypeConfigCreated.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PerTypeConfigCreated.fromSuiObjectData(
            res.data
        );
    }
}
...
export class PerTypeList implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PerTypeList.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PerTypeList.fromSuiObjectData(
            res.data
        );
    }
}
