...
export class Display<T extends PhantomTypeArgument> implements StructClass {
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return Display.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Display.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class DisplayCreated<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                DisplayCreated.fromSuiObjectData(
                    T,
                    content,
                ),
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return DisplayCreated.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DisplayCreated.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class VersionUpdated<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                VersionUpdated.fromSuiObjectData(
                    T,
                    content,
                ),
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return VersionUpdated.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return VersionUpdated.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
