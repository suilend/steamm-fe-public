...
export class Curve implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Curve.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Curve.fromSuiObjectData(
            res.data
        );
    }
}
...
export class PreparedVerifyingKey implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PreparedVerifyingKey.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PreparedVerifyingKey.fromSuiObjectData(
            res.data
        );
    }
}
...
export class ProofPoints implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ProofPoints.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ProofPoints.fromSuiObjectData(
            res.data
        );
    }
}
...
export class PublicProofInputs implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PublicProofInputs.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PublicProofInputs.fromSuiObjectData(
            res.data
        );
    }
}
