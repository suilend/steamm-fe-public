...
export class Publisher implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Publisher.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Publisher.fromSuiObjectData(
            res.data
        );
    }
}
...
export class UpgradeCap implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return UpgradeCap.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UpgradeCap.fromSuiObjectData(
            res.data
        );
    }
}
...
export class UpgradeReceipt implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return UpgradeReceipt.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UpgradeReceipt.fromSuiObjectData(
            res.data
        );
    }
}
...
export class UpgradeTicket implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return UpgradeTicket.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UpgradeTicket.fromSuiObjectData(
            res.data
        );
    }
}
