...
export class Random implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Random.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Random.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface RandomGeneratorFields {
    seed: ToField<Vector<"u8">>; counter: ToField<"u16">; buffer: ToField<Vector<"u8">>
}
...
export class RandomGenerator implements StructClass {
    ...
    static reified(): RandomGeneratorReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                RandomGenerator.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                RandomGenerator.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                RandomGenerator.fromBcs(
                    data,
                ),
            bcs: RandomGenerator.bcs,
            fromJSONField: (field: any) =>
                RandomGenerator.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                RandomGenerator.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                RandomGenerator.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromFields(
        ...
        return RandomGenerator.reified().new(
            {seed: decodeFromFields(reified.vector("u8"), fields.seed), counter: decodeFromFields("u16", fields.counter), buffer: decodeFromFields(reified.vector("u8"), fields.buffer)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return RandomGenerator.reified().new(
            {seed: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.seed), counter: decodeFromFieldsWithTypes("u16", item.fields.counter), buffer: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.buffer)}
        )
    }
    ...
    static fromBcs(
        ...
        return RandomGenerator.fromFields(
            RandomGenerator.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return RandomGenerator.reified().new(
            {seed: decodeFromJSONField(reified.vector("u8"), field.seed), counter: decodeFromJSONField("u16", field.counter), buffer: decodeFromJSONField(reified.vector("u8"), field.buffer)}
        )
    }
    ...
    static fromJSON(
        ...
        return RandomGenerator.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return RandomGenerator.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return RandomGenerator.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return RandomGenerator.fromSuiObjectData(
            res.data
        );
    }
}
...
export class RandomInner implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return RandomInner.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return RandomInner.fromSuiObjectData(
            res.data
        );
    }
}
