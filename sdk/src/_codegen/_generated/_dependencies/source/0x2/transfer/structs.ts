...
export class Receiving<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromSuiObjectData: (content: SuiObjectData) =>
                Receiving.fromSuiObjectData(
                    T,
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Receiving.fetch(
                client,
                T,
                id,
            ),
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return Receiving.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Receiving.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
