...
export class VersionChangeCap implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return VersionChangeCap.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return VersionChangeCap.fromSuiObjectData(
            res.data
        );
    }
}
...
export class Versioned implements StructClass {
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Versioned.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Versioned.fromSuiObjectData(
            res.data
        );
    }
}
