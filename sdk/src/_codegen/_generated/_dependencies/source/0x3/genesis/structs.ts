...
export class GenesisChainParameters implements StructClass {
    ...
    readonly protocolVersion:
        ToField<"u64">
    ; readonly chainStartTimestampMs:
        ToField<"u64">
    ; readonly epochDurationMs:
        ToField<"u64">
    ; readonly stakeSubsidyStartEpoch:
        ToField<"u64">
    ; readonly stakeSubsidyInitialDistributionAmount:
        ToField<"u64">
    ; readonly stakeSubsidyPeriodLength:
        ToField<"u64">
    ; readonly stakeSubsidyDecreaseRate:
        ToField<"u16">
    ...
    static reified(): GenesisChainParametersReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                GenesisChainParameters.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GenesisChainParameters.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GenesisChainParameters.fromBcs(
                    data,
                ),
            bcs: GenesisChainParameters.bcs,
            fromJSONField: (field: any) =>
                GenesisChainParameters.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GenesisChainParameters.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GenesisChainParameters.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: GenesisChainParametersFields,
            ) => {
                return new GenesisChainParameters(
                    [],
                    fields
                )
            },
    ...
    static fromJSON(
        ...
        return GenesisChainParameters.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isGenesisChainParameters(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a GenesisChainParameters object`);
        }
        return GenesisChainParameters.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GenesisChainParameters.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GenesisChainParameters.fromSuiObjectData(
            res.data
        );
    }
}
...
export class GenesisValidatorMetadata implements StructClass {
    ...
    ; readonly commissionRate:
        ToField<"u64">
    ; readonly protocolPublicKey:
        ToField<Vector<"u8">>
    ; readonly proofOfPossession:
        ToField<Vector<"u8">>
    ; readonly networkPublicKey:
        ToField<Vector<"u8">>
    ; readonly workerPublicKey:
        ToField<Vector<"u8">>
    ...
    static reified(): GenesisValidatorMetadataReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                GenesisValidatorMetadata.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GenesisValidatorMetadata.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GenesisValidatorMetadata.fromBcs(
                    data,
                ),
            bcs: GenesisValidatorMetadata.bcs,
            fromJSONField: (field: any) =>
                GenesisValidatorMetadata.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GenesisValidatorMetadata.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GenesisValidatorMetadata.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: GenesisValidatorMetadataFields,
            ) => {
                return new GenesisValidatorMetadata(
                    [],
                    fields
                )
            },
    ...
    static fromJSON(
        ...
        return GenesisValidatorMetadata.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isGenesisValidatorMetadata(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a GenesisValidatorMetadata object`);
        }
        return GenesisValidatorMetadata.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GenesisValidatorMetadata.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isGenesisValidatorMetadata(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a GenesisValidatorMetadata object`);
        }

        return GenesisValidatorMetadata.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface TokenAllocationFields {
    recipientAddress: ToField<"address">; amountMist: ToField<"u64">; stakedWithValidator: ToField<Option<"address">>
}
...
export class TokenAllocation implements StructClass {
    ...
    static reified(): TokenAllocationReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                TokenAllocation.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                TokenAllocation.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                TokenAllocation.fromBcs(
                    data,
                ),
            bcs: TokenAllocation.bcs,
            fromJSONField: (field: any) =>
                TokenAllocation.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                TokenAllocation.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                TokenAllocation.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromFields(
        ...
        return TokenAllocation.reified().new(
            {recipientAddress: decodeFromFields("address", fields.recipient_address), amountMist: decodeFromFields("u64", fields.amount_mist), stakedWithValidator: decodeFromFields(Option.reified("address"), fields.staked_with_validator)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return TokenAllocation.reified().new(
            {recipientAddress: decodeFromFieldsWithTypes("address", item.fields.recipient_address), amountMist: decodeFromFieldsWithTypes("u64", item.fields.amount_mist), stakedWithValidator: decodeFromFieldsWithTypes(Option.reified("address"), item.fields.staked_with_validator)}
        )
    }
    ...
    static fromBcs(
        ...
        return TokenAllocation.fromFields(
            TokenAllocation.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return TokenAllocation.reified().new(
            {recipientAddress: decodeFromJSONField("address", field.recipientAddress), amountMist: decodeFromJSONField("u64", field.amountMist), stakedWithValidator: decodeFromJSONField(Option.reified("address"), field.stakedWithValidator)}
        )
    }
    ...
    static fromJSON(
        ...
        return TokenAllocation.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return TokenAllocation.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return TokenAllocation.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return TokenAllocation.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface TokenDistributionScheduleFields {
    stakeSubsidyFundMist: ToField<"u64">; allocations: ToField<Vector<TokenAllocation>>
}
...
export class TokenDistributionSchedule implements StructClass {
    ...
    readonly stakeSubsidyFundMist:
        ToField<"u64">
    ; readonly allocations:
        ToField<Vector<TokenAllocation>>
    ...
    static reified(): TokenDistributionScheduleReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                TokenDistributionSchedule.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                TokenDistributionSchedule.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                TokenDistributionSchedule.fromBcs(
                    data,
                ),
            bcs: TokenDistributionSchedule.bcs,
            fromJSONField: (field: any) =>
                TokenDistributionSchedule.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                TokenDistributionSchedule.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                TokenDistributionSchedule.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: TokenDistributionScheduleFields,
            ) => {
                return new TokenDistributionSchedule(
                    [],
                    fields
                )
            },
    ...
    static get bcs() {
        return bcs.struct("TokenDistributionSchedule", {
            stake_subsidy_fund_mist:
                bcs.u64()
            , allocations:
                bcs.vector(TokenAllocation.bcs)
    ...
    static fromFields(
        ...
        return TokenDistributionSchedule.reified().new(
            {stakeSubsidyFundMist: decodeFromFields("u64", fields.stake_subsidy_fund_mist), allocations: decodeFromFields(reified.vector(TokenAllocation.reified()), fields.allocations)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return TokenDistributionSchedule.reified().new(
            {stakeSubsidyFundMist: decodeFromFieldsWithTypes("u64", item.fields.stake_subsidy_fund_mist), allocations: decodeFromFieldsWithTypes(reified.vector(TokenAllocation.reified()), item.fields.allocations)}
        )
    }
    ...
    static fromJSONField(
        ...
        return TokenDistributionSchedule.reified().new(
            {stakeSubsidyFundMist: decodeFromJSONField("u64", field.stakeSubsidyFundMist), allocations: decodeFromJSONField(reified.vector(TokenAllocation.reified()), field.allocations)}
        )
    }
    ...
    static fromJSON(
        ...
        return TokenDistributionSchedule.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isTokenDistributionSchedule(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a TokenDistributionSchedule object`);
        }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return TokenDistributionSchedule.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isTokenDistributionSchedule(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a TokenDistributionSchedule object`);
        }

        return TokenDistributionSchedule.fromSuiObjectData(
            res.data
        );
    }
}
