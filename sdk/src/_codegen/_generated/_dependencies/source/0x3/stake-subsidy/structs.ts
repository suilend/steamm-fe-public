...
export function isStakeSubsidy(type: string): boolean {
    ...
    return type === `${PKG_V18}::stake_subsidy::StakeSubsidy`;
}

export interface StakeSubsidyFields {
    balance: ToField<Balance<ToPhantom<SUI>>>; distributionCounter: ToField<"u64">; currentDistributionAmount: ToField<"u64">; stakeSubsidyPeriodLength: ToField<"u64">; stakeSubsidyDecreaseRate: ToField<"u16">; extraFields: ToField<Bag>
}

export type StakeSubsidyReified = Reified<
    StakeSubsidy,
    StakeSubsidyFields
>;
...
export class StakeSubsidy implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::stake_subsidy::StakeSubsidy`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = StakeSubsidy.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::stake_subsidy::StakeSubsidy`;
    readonly $typeArgs: [];
    readonly $isPhantom = StakeSubsidy.$isPhantom;

    readonly balance:
        ToField<Balance<ToPhantom<SUI>>>
    ; readonly distributionCounter:
        ToField<"u64">
    ; readonly currentDistributionAmount:
        ToField<"u64">
    ...
    private constructor(typeArgs: [], fields: StakeSubsidyFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::stake_subsidy::StakeSubsidy`;
    ...
    static reified(): StakeSubsidyReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                StakeSubsidy.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                StakeSubsidy.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                StakeSubsidy.fromBcs(
                    data,
                ),
            bcs: StakeSubsidy.bcs,
            fromJSONField: (field: any) =>
                StakeSubsidy.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                StakeSubsidy.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                StakeSubsidy.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                StakeSubsidy.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => StakeSubsidy.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromBcs(
        ...
        return StakeSubsidy.fromFields(
            StakeSubsidy.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return StakeSubsidy.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return StakeSubsidy.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return StakeSubsidy.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return StakeSubsidy.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return StakeSubsidy.fromSuiObjectData(
            res.data
        );
    }
}
