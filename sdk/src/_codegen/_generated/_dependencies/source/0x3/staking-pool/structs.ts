...
export function isFungibleStakedSui(type: string): boolean {
    ...
    return type === `${PKG_V18}::staking_pool::FungibleStakedSui`;
}

export interface FungibleStakedSuiFields {
    id: ToField<UID>; poolId: ToField<ID>; value: ToField<"u64">
}
...
export class FungibleStakedSui implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::staking_pool::FungibleStakedSui`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = FungibleStakedSui.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::staking_pool::FungibleStakedSui`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: FungibleStakedSuiFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::staking_pool::FungibleStakedSui`;
    ...
    static reified(): FungibleStakedSuiReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                FungibleStakedSui.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                FungibleStakedSui.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                FungibleStakedSui.fromBcs(
                    data,
                ),
            bcs: FungibleStakedSui.bcs,
            fromJSONField: (field: any) =>
                FungibleStakedSui.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                FungibleStakedSui.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                FungibleStakedSui.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                FungibleStakedSui.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => FungibleStakedSui.fetch(
                client,
                id,
            ),
            new: (
                fields: FungibleStakedSuiFields,
            ) => {
                return new FungibleStakedSui(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return FungibleStakedSui.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), poolId: decodeFromFields(ID.reified(), fields.pool_id), value: decodeFromFields("u64", fields.value)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return FungibleStakedSui.reified().new(
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), poolId: decodeFromFieldsWithTypes(ID.reified(), item.fields.pool_id), value: decodeFromFieldsWithTypes("u64", item.fields.value)}
        )
    }
    ...
    static fromBcs(
        ...
        return FungibleStakedSui.fromFields(
            FungibleStakedSui.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return FungibleStakedSui.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), poolId: decodeFromJSONField(ID.reified(), field.poolId), value: decodeFromJSONField("u64", field.value)}
        )
    }
    ...
    static fromJSON(
        ...
        return FungibleStakedSui.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return FungibleStakedSui.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return FungibleStakedSui.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return FungibleStakedSui.fromSuiObjectData(
            res.data
        );
    }
}
...
export function isFungibleStakedSuiData(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V18}::staking_pool::FungibleStakedSuiData`;
}

export interface FungibleStakedSuiDataFields {
    id: ToField<UID>; totalSupply: ToField<"u64">; principal: ToField<Balance<ToPhantom<SUI>>>
}
...
export class FungibleStakedSuiData implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::staking_pool::FungibleStakedSuiData`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = FungibleStakedSuiData.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::staking_pool::FungibleStakedSuiData`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: FungibleStakedSuiDataFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::staking_pool::FungibleStakedSuiData`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): FungibleStakedSuiDataReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                FungibleStakedSuiData.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                FungibleStakedSuiData.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                FungibleStakedSuiData.fromBcs(
                    data,
                ),
            bcs: FungibleStakedSuiData.bcs,
            fromJSONField: (field: any) =>
                FungibleStakedSuiData.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                FungibleStakedSuiData.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                FungibleStakedSuiData.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                FungibleStakedSuiData.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => FungibleStakedSuiData.fetch(
                client,
                id,
            ),
            new: (
                fields: FungibleStakedSuiDataFields,
            ) => {
                return new FungibleStakedSuiData(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return FungibleStakedSuiData.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), totalSupply: decodeFromFields("u64", fields.total_supply), principal: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.principal)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return FungibleStakedSuiData.reified().new(
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), totalSupply: decodeFromFieldsWithTypes("u64", item.fields.total_supply), principal: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.principal)}
        )
    }
    ...
    static fromJSONField(
        ...
        return FungibleStakedSuiData.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), totalSupply: decodeFromJSONField("u64", field.totalSupply), principal: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.principal)}
        )
    }
    ...
    static fromJSON(
        ...
        return FungibleStakedSuiData.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isFungibleStakedSuiData(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a FungibleStakedSuiData object`);
        }
        return FungibleStakedSuiData.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return FungibleStakedSuiData.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return FungibleStakedSuiData.fromSuiObjectData(
            res.data
        );
    }
}
...
export function isFungibleStakedSuiDataKey(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V18}::staking_pool::FungibleStakedSuiDataKey`;
}
...
export class FungibleStakedSuiDataKey implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::staking_pool::FungibleStakedSuiDataKey`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = FungibleStakedSuiDataKey.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::staking_pool::FungibleStakedSuiDataKey`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: FungibleStakedSuiDataKeyFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::staking_pool::FungibleStakedSuiDataKey`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): FungibleStakedSuiDataKeyReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                FungibleStakedSuiDataKey.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                FungibleStakedSuiDataKey.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                FungibleStakedSuiDataKey.fromBcs(
                    data,
                ),
            bcs: FungibleStakedSuiDataKey.bcs,
            fromJSONField: (field: any) =>
                FungibleStakedSuiDataKey.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                FungibleStakedSuiDataKey.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                FungibleStakedSuiDataKey.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                FungibleStakedSuiDataKey.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => FungibleStakedSuiDataKey.fetch(
                client,
                id,
            ),
            new: (
                fields: FungibleStakedSuiDataKeyFields,
            ) => {
                return new FungibleStakedSuiDataKey(
                    [],
                    fields
                )
            },
    ...
    static fromJSON(
        ...
        return FungibleStakedSuiDataKey.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isFungibleStakedSuiDataKey(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a FungibleStakedSuiDataKey object`);
        }
        return FungibleStakedSuiDataKey.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return FungibleStakedSuiDataKey.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isFungibleStakedSuiDataKey(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a FungibleStakedSuiDataKey object`);
        }

        return FungibleStakedSuiDataKey.fromSuiObjectData(
            res.data
        );
    }
}
...
export function isPoolTokenExchangeRate(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V18}::staking_pool::PoolTokenExchangeRate`;
}

export interface PoolTokenExchangeRateFields {
    suiAmount: ToField<"u64">; poolTokenAmount: ToField<"u64">
}
...
export class PoolTokenExchangeRate implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::staking_pool::PoolTokenExchangeRate`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = PoolTokenExchangeRate.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::staking_pool::PoolTokenExchangeRate`;
    readonly $typeArgs: [];
    readonly $isPhantom = PoolTokenExchangeRate.$isPhantom;

    readonly suiAmount:
        ToField<"u64">
    ; readonly poolTokenAmount:
        ToField<"u64">
    ...
    private constructor(typeArgs: [], fields: PoolTokenExchangeRateFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::staking_pool::PoolTokenExchangeRate`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): PoolTokenExchangeRateReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                PoolTokenExchangeRate.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PoolTokenExchangeRate.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                PoolTokenExchangeRate.fromBcs(
                    data,
                ),
            bcs: PoolTokenExchangeRate.bcs,
            fromJSONField: (field: any) =>
                PoolTokenExchangeRate.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PoolTokenExchangeRate.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PoolTokenExchangeRate.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                PoolTokenExchangeRate.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => PoolTokenExchangeRate.fetch(
                client,
                id,
            ),
            new: (
                fields: PoolTokenExchangeRateFields,
            ) => {
                return new PoolTokenExchangeRate(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return PoolTokenExchangeRate.reified().new(
            {suiAmount: decodeFromFields("u64", fields.sui_amount), poolTokenAmount: decodeFromFields("u64", fields.pool_token_amount)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return PoolTokenExchangeRate.reified().new(
            {suiAmount: decodeFromFieldsWithTypes("u64", item.fields.sui_amount), poolTokenAmount: decodeFromFieldsWithTypes("u64", item.fields.pool_token_amount)}
        )
    }
    ...
    static fromJSONField(
        ...
        return PoolTokenExchangeRate.reified().new(
            {suiAmount: decodeFromJSONField("u64", field.suiAmount), poolTokenAmount: decodeFromJSONField("u64", field.poolTokenAmount)}
        )
    }
    ...
    static fromJSON(
        ...
        return PoolTokenExchangeRate.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isPoolTokenExchangeRate(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a PoolTokenExchangeRate object`);
        }
        return PoolTokenExchangeRate.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PoolTokenExchangeRate.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PoolTokenExchangeRate.fromSuiObjectData(
            res.data
        );
    }
}
...
export function isStakedSui(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V18}::staking_pool::StakedSui`;
}

export interface StakedSuiFields {
    id: ToField<UID>; poolId: ToField<ID>; stakeActivationEpoch: ToField<"u64">; principal: ToField<Balance<ToPhantom<SUI>>>
}

export type StakedSuiReified = Reified<
    StakedSui,
    StakedSuiFields
>;
...
export class StakedSui implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::staking_pool::StakedSui`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = StakedSui.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::staking_pool::StakedSui`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: StakedSuiFields,
        ...
        this.$fullTypeName = composeSuiType(
            StakedSui.$typeName,
            ...typeArgs
        ) as `${typeof PKG_V18}::staking_pool::StakedSui`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): StakedSuiReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                StakedSui.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                StakedSui.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                StakedSui.fromBcs(
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                StakedSui.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                StakedSui.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => StakedSui.fetch(
                client,
                id,
            ),
            new: (
                fields: StakedSuiFields,
            ) => {
    ...
    static fromFields(
        ...
        return StakedSui.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), poolId: decodeFromFields(ID.reified(), fields.pool_id), stakeActivationEpoch: decodeFromFields("u64", fields.stake_activation_epoch), principal: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.principal)}
        )
    }
    ...
    static fromBcs(
        ...
        return StakedSui.fromFields(
            StakedSui.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return StakedSui.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), poolId: decodeFromJSONField(ID.reified(), field.poolId), stakeActivationEpoch: decodeFromJSONField("u64", field.stakeActivationEpoch), principal: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.principal)}
        )
    }
    ...
    static fromJSON(
        ...
        return StakedSui.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return StakedSui.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return StakedSui.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return StakedSui.fromSuiObjectData(
            res.data
        );
    }
}
...
export function isStakingPool(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V18}::staking_pool::StakingPool`;
}
...
export type StakingPoolReified = Reified<
    StakingPool,
    StakingPoolFields
>;
...
export class StakingPool implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::staking_pool::StakingPool`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = StakingPool.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::staking_pool::StakingPool`;
    readonly $typeArgs: [];
    ...
    ; readonly exchangeRates:
        ToField<Table<"u64", ToPhantom<PoolTokenExchangeRate>>>
    ; readonly pendingStake:
        ToField<"u64">
    ; readonly pendingTotalSuiWithdraw:
        ToField<"u64">
    ; readonly pendingPoolTokenWithdraw:
        ToField<"u64">
    ...
    private constructor(typeArgs: [], fields: StakingPoolFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::staking_pool::StakingPool`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): StakingPoolReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                StakingPool.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                StakingPool.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                StakingPool.fromBcs(
            ...
            bcs: StakingPool.bcs,
            fromJSONField: (field: any) =>
                StakingPool.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                StakingPool.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                StakingPool.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                StakingPool.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => StakingPool.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromBcs(
        ...
        return StakingPool.fromFields(
            StakingPool.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return StakingPool.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return StakingPool.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return StakingPool.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return StakingPool.fromSuiObjectData(
            res.data
        );
    }
}
