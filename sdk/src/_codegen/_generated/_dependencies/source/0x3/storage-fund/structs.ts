...
export function isStorageFund(type: string): boolean {
    ...
    return type === `${PKG_V18}::storage_fund::StorageFund`;
}

export interface StorageFundFields {
    totalObjectStorageRebates: ToField<Balance<ToPhantom<SUI>>>; nonRefundableBalance: ToField<Balance<ToPhantom<SUI>>>
}

export type StorageFundReified = Reified<
    StorageFund,
    StorageFundFields
>;
...
export class StorageFund implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::storage_fund::StorageFund`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = StorageFund.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::storage_fund::StorageFund`;
    readonly $typeArgs: [];
    readonly $isPhantom = StorageFund.$isPhantom;

    readonly totalObjectStorageRebates:
        ToField<Balance<ToPhantom<SUI>>>
    ; readonly nonRefundableBalance:
        ToField<Balance<ToPhantom<SUI>>>
    ...
    private constructor(typeArgs: [], fields: StorageFundFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::storage_fund::StorageFund`;
    ...
    static reified(): StorageFundReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                StorageFund.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                StorageFund.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromJSONField: (field: any) =>
                StorageFund.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                StorageFund.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                StorageFund.fromSuiParsedData(
                    content,
                ),
    ...
    static fromFields(
        ...
        return StorageFund.reified().new(
            {totalObjectStorageRebates: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.total_object_storage_rebates), nonRefundableBalance: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.non_refundable_balance)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return StorageFund.reified().new(
            {totalObjectStorageRebates: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.total_object_storage_rebates), nonRefundableBalance: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.non_refundable_balance)}
        )
    }
    ...
    static fromBcs(
        ...
        return StorageFund.fromFields(
            StorageFund.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return StorageFund.reified().new(
            {totalObjectStorageRebates: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.totalObjectStorageRebates), nonRefundableBalance: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.nonRefundableBalance)}
        )
    }
    ...
    static fromJSON(
        ...
        return StorageFund.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return StorageFund.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return StorageFund.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return StorageFund.fromSuiObjectData(
            res.data
        );
    }
}
