...
export function isUnverifiedValidatorOperationCap(type: string): boolean {
    ...
    return type === `${PKG_V18}::validator_cap::UnverifiedValidatorOperationCap`;
}

export interface UnverifiedValidatorOperationCapFields {
    id: ToField<UID>; authorizerValidatorAddress: ToField<"address">
}
...
export class UnverifiedValidatorOperationCap implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::validator_cap::UnverifiedValidatorOperationCap`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = UnverifiedValidatorOperationCap.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::validator_cap::UnverifiedValidatorOperationCap`;
    readonly $typeArgs: [];
    readonly $isPhantom = UnverifiedValidatorOperationCap.$isPhantom;

    readonly id:
        ToField<UID>
    ; readonly authorizerValidatorAddress:
        ToField<"address">
    ...
    private constructor(typeArgs: [], fields: UnverifiedValidatorOperationCapFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::validator_cap::UnverifiedValidatorOperationCap`;
    ...
    static reified(): UnverifiedValidatorOperationCapReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                UnverifiedValidatorOperationCap.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                UnverifiedValidatorOperationCap.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                UnverifiedValidatorOperationCap.fromBcs(
                    data,
                ),
            bcs: UnverifiedValidatorOperationCap.bcs,
            fromJSONField: (field: any) =>
                UnverifiedValidatorOperationCap.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                UnverifiedValidatorOperationCap.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                UnverifiedValidatorOperationCap.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                ...
                return new UnverifiedValidatorOperationCap(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return UnverifiedValidatorOperationCap.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), authorizerValidatorAddress: decodeFromFields("address", fields.authorizer_validator_address)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return UnverifiedValidatorOperationCap.reified().new(
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), authorizerValidatorAddress: decodeFromFieldsWithTypes("address", item.fields.authorizer_validator_address)}
        )
    }
    ...
    static fromJSONField(
        ...
        return UnverifiedValidatorOperationCap.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), authorizerValidatorAddress: decodeFromJSONField("address", field.authorizerValidatorAddress)}
        )
    }
    ...
    static fromJSON(
        ...
        return UnverifiedValidatorOperationCap.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isUnverifiedValidatorOperationCap(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a UnverifiedValidatorOperationCap object`);
        }
        return UnverifiedValidatorOperationCap.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return UnverifiedValidatorOperationCap.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isUnverifiedValidatorOperationCap(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a UnverifiedValidatorOperationCap object`);
        }

        return UnverifiedValidatorOperationCap.fromSuiObjectData(
            res.data
        );
    }
}
...
export function isValidatorOperationCap(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V18}::validator_cap::ValidatorOperationCap`;
}
...
export class ValidatorOperationCap implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::validator_cap::ValidatorOperationCap`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = ValidatorOperationCap.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::validator_cap::ValidatorOperationCap`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: ValidatorOperationCapFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::validator_cap::ValidatorOperationCap`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): ValidatorOperationCapReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                ValidatorOperationCap.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                ValidatorOperationCap.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                ValidatorOperationCap.fromBcs(
                    data,
                ),
            bcs: ValidatorOperationCap.bcs,
            fromJSONField: (field: any) =>
                ValidatorOperationCap.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                ValidatorOperationCap.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                ValidatorOperationCap.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: ValidatorOperationCapFields,
            ) => {
                return new ValidatorOperationCap(
                    [],
                    fields
                )
            },
    ...
    static fromFieldsWithTypes(
        ...
        return ValidatorOperationCap.reified().new(
            {authorizerValidatorAddress: decodeFromFieldsWithTypes("address", item.fields.authorizer_validator_address)}
        )
    }
    ...
    static fromJSON(
        ...
        return ValidatorOperationCap.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isValidatorOperationCap(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a ValidatorOperationCap object`);
        }
        return ValidatorOperationCap.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ValidatorOperationCap.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ValidatorOperationCap.fromSuiObjectData(
            res.data
        );
    }
}
