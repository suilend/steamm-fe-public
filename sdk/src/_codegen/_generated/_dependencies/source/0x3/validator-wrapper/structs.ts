...
export class ValidatorWrapper implements StructClass {
    ...
    static reified(): ValidatorWrapperReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                ValidatorWrapper.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                ValidatorWrapper.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                ValidatorWrapper.fromBcs(
                    data,
                ),
            bcs: ValidatorWrapper.bcs,
            fromJSONField: (field: any) =>
                ValidatorWrapper.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                ValidatorWrapper.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                ValidatorWrapper.fromSuiParsedData(
                    content,
                ),
    ...
    static fromBcs(
        ...
        return ValidatorWrapper.fromFields(
            ValidatorWrapper.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return ValidatorWrapper.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return ValidatorWrapper.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ValidatorWrapper.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ValidatorWrapper.fromSuiObjectData(
            res.data
        );
    }
}
