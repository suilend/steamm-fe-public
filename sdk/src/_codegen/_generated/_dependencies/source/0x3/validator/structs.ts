...
export interface ConvertingToFungibleStakedSuiEventFields {
    poolId: ToField<ID>; stakeActivationEpoch: ToField<"u64">; stakedSuiPrincipalAmount: ToField<"u64">; fungibleStakedSuiAmount: ToField<"u64">
}
...
export class ConvertingToFungibleStakedSuiEvent implements StructClass {
    ...
    readonly poolId:
        ToField<ID>
    ; readonly stakeActivationEpoch:
        ToField<"u64">
    ; readonly stakedSuiPrincipalAmount:
        ToField<"u64">
    ; readonly fungibleStakedSuiAmount:
        ToField<"u64">
    ...
    static reified(): ConvertingToFungibleStakedSuiEventReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                ConvertingToFungibleStakedSuiEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                ConvertingToFungibleStakedSuiEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                ConvertingToFungibleStakedSuiEvent.fromBcs(
                    data,
                ),
            bcs: ConvertingToFungibleStakedSuiEvent.bcs,
            fromJSONField: (field: any) =>
                ConvertingToFungibleStakedSuiEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                ConvertingToFungibleStakedSuiEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                ConvertingToFungibleStakedSuiEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                ConvertingToFungibleStakedSuiEvent.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => ConvertingToFungibleStakedSuiEvent.fetch(
                client,
                id,
            ),
            new: (
                ...
                return new ConvertingToFungibleStakedSuiEvent(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return ConvertingToFungibleStakedSuiEvent.reified().new(
            {poolId: decodeFromFields(ID.reified(), fields.pool_id), stakeActivationEpoch: decodeFromFields("u64", fields.stake_activation_epoch), stakedSuiPrincipalAmount: decodeFromFields("u64", fields.staked_sui_principal_amount), fungibleStakedSuiAmount: decodeFromFields("u64", fields.fungible_staked_sui_amount)}
        )
    }
    ...
    static fromJSONField(
        ...
        return ConvertingToFungibleStakedSuiEvent.reified().new(
            {poolId: decodeFromJSONField(ID.reified(), field.poolId), stakeActivationEpoch: decodeFromJSONField("u64", field.stakeActivationEpoch), stakedSuiPrincipalAmount: decodeFromJSONField("u64", field.stakedSuiPrincipalAmount), fungibleStakedSuiAmount: decodeFromJSONField("u64", field.fungibleStakedSuiAmount)}
        )
    }
    ...
    static fromJSON(
        ...
        return ConvertingToFungibleStakedSuiEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isConvertingToFungibleStakedSuiEvent(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a ConvertingToFungibleStakedSuiEvent object`);
        }
        return ConvertingToFungibleStakedSuiEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ConvertingToFungibleStakedSuiEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isConvertingToFungibleStakedSuiEvent(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a ConvertingToFungibleStakedSuiEvent object`);
        }

        return ConvertingToFungibleStakedSuiEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface RedeemingFungibleStakedSuiEventFields {
    poolId: ToField<ID>; fungibleStakedSuiAmount: ToField<"u64">; suiAmount: ToField<"u64">
}
...
export class RedeemingFungibleStakedSuiEvent implements StructClass {
    ...
    static reified(): RedeemingFungibleStakedSuiEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                RedeemingFungibleStakedSuiEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                RedeemingFungibleStakedSuiEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                RedeemingFungibleStakedSuiEvent.fromBcs(
                    data,
                ),
            bcs: RedeemingFungibleStakedSuiEvent.bcs,
            fromJSONField: (field: any) =>
                RedeemingFungibleStakedSuiEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                RedeemingFungibleStakedSuiEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                RedeemingFungibleStakedSuiEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                RedeemingFungibleStakedSuiEvent.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => RedeemingFungibleStakedSuiEvent.fetch(
                client,
                id,
            ),
            new: (
                ...
                return new RedeemingFungibleStakedSuiEvent(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return RedeemingFungibleStakedSuiEvent.reified().new(
            {poolId: decodeFromFields(ID.reified(), fields.pool_id), fungibleStakedSuiAmount: decodeFromFields("u64", fields.fungible_staked_sui_amount), suiAmount: decodeFromFields("u64", fields.sui_amount)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return RedeemingFungibleStakedSuiEvent.reified().new(
            {poolId: decodeFromFieldsWithTypes(ID.reified(), item.fields.pool_id), fungibleStakedSuiAmount: decodeFromFieldsWithTypes("u64", item.fields.fungible_staked_sui_amount), suiAmount: decodeFromFieldsWithTypes("u64", item.fields.sui_amount)}
        )
    }
    ...
    static fromJSONField(
        ...
        return RedeemingFungibleStakedSuiEvent.reified().new(
            {poolId: decodeFromJSONField(ID.reified(), field.poolId), fungibleStakedSuiAmount: decodeFromJSONField("u64", field.fungibleStakedSuiAmount), suiAmount: decodeFromJSONField("u64", field.suiAmount)}
        )
    }
    ...
    static fromJSON(
        ...
        return RedeemingFungibleStakedSuiEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isRedeemingFungibleStakedSuiEvent(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a RedeemingFungibleStakedSuiEvent object`);
        }
        return RedeemingFungibleStakedSuiEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return RedeemingFungibleStakedSuiEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isRedeemingFungibleStakedSuiEvent(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a RedeemingFungibleStakedSuiEvent object`);
        }

        return RedeemingFungibleStakedSuiEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface StakingRequestEventFields {
    poolId: ToField<ID>; validatorAddress: ToField<"address">; stakerAddress: ToField<"address">; epoch: ToField<"u64">; amount: ToField<"u64">
}
...
export class StakingRequestEvent implements StructClass {
    ...
    static reified(): StakingRequestEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                StakingRequestEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                StakingRequestEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                StakingRequestEvent.fromBcs(
                    data,
                ),
            bcs: StakingRequestEvent.bcs,
            fromJSONField: (field: any) =>
                StakingRequestEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                StakingRequestEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                StakingRequestEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                StakingRequestEvent.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => StakingRequestEvent.fetch(
                client,
                id,
            ),
            new: (
                fields: StakingRequestEventFields,
            ) => {
                return new StakingRequestEvent(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return StakingRequestEvent.reified().new(
            {poolId: decodeFromFields(ID.reified(), fields.pool_id), validatorAddress: decodeFromFields("address", fields.validator_address), stakerAddress: decodeFromFields("address", fields.staker_address), epoch: decodeFromFields("u64", fields.epoch), amount: decodeFromFields("u64", fields.amount)}
        )
    }
    ...
    static fromBcs(
        ...
        return StakingRequestEvent.fromFields(
            StakingRequestEvent.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return StakingRequestEvent.reified().new(
            {poolId: decodeFromJSONField(ID.reified(), field.poolId), validatorAddress: decodeFromJSONField("address", field.validatorAddress), stakerAddress: decodeFromJSONField("address", field.stakerAddress), epoch: decodeFromJSONField("u64", field.epoch), amount: decodeFromJSONField("u64", field.amount)}
        )
    }
    ...
    static fromJSON(
        ...
        return StakingRequestEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return StakingRequestEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return StakingRequestEvent.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return StakingRequestEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return StakingRequestEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface UnstakingRequestEventFields {
    poolId: ToField<ID>; validatorAddress: ToField<"address">; stakerAddress: ToField<"address">; stakeActivationEpoch: ToField<"u64">; unstakingEpoch: ToField<"u64">; principalAmount: ToField<"u64">; rewardAmount: ToField<"u64">
}
...
export class UnstakingRequestEvent implements StructClass {
    ...
    static reified(): UnstakingRequestEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                UnstakingRequestEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                UnstakingRequestEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                UnstakingRequestEvent.fromBcs(
                    data,
                ),
            bcs: UnstakingRequestEvent.bcs,
            fromJSONField: (field: any) =>
                UnstakingRequestEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                UnstakingRequestEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                UnstakingRequestEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                UnstakingRequestEvent.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => UnstakingRequestEvent.fetch(
                client,
                id,
            ),
            new: (
                fields: UnstakingRequestEventFields,
            ) => {
                return new UnstakingRequestEvent(
                    [],
                    fields
                )
            },
    ...
    static fromJSON(
        ...
        return UnstakingRequestEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isUnstakingRequestEvent(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a UnstakingRequestEvent object`);
        }
        return UnstakingRequestEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return UnstakingRequestEvent.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return UnstakingRequestEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UnstakingRequestEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface ValidatorFields {
    metadata: ToField<ValidatorMetadata>; votingPower: ToField<"u64">; operationCapId: ToField<ID>; gasPrice: ToField<"u64">; stakingPool: ToField<StakingPool>; commissionRate: ToField<"u64">; nextEpochStake: ToField<"u64">; nextEpochGasPrice: ToField<"u64">; nextEpochCommissionRate: ToField<"u64">; extraFields: ToField<Bag>
}

export type ValidatorReified = Reified<
    Validator,
    ValidatorFields
>;
...
export class Validator implements StructClass {
    ...
    readonly metadata:
        ToField<ValidatorMetadata>
    ; readonly votingPower:
        ToField<"u64">
    ; readonly operationCapId:
        ToField<ID>
    ; readonly gasPrice:
        ToField<"u64">
    ...
    ; readonly commissionRate:
        ToField<"u64">
    ; readonly nextEpochStake:
        ToField<"u64">
    ; readonly nextEpochGasPrice:
        ToField<"u64">
    ; readonly nextEpochCommissionRate:
        ToField<"u64">
    ...
    static reified(): ValidatorReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                Validator.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                Validator.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                Validator.fromBcs(
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Validator.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Validator.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Validator.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromBcs(
        ...
        return Validator.fromFields(
            Validator.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return Validator.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Validator.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return Validator.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return Validator.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Validator.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface ValidatorMetadataFields {
    suiAddress: ToField<"address">; protocolPubkeyBytes: ToField<Vector<"u8">>; networkPubkeyBytes: ToField<Vector<"u8">>; workerPubkeyBytes: ToField<Vector<"u8">>; proofOfPossession: ToField<Vector<"u8">>; name: ToField<String>; description: ToField<String>; imageUrl: ToField<Url>; projectUrl: ToField<Url>; netAddress: ToField<String>; p2PAddress: ToField<String>; primaryAddress: ToField<String>; workerAddress: ToField<String>; nextEpochProtocolPubkeyBytes: ToField<Option<Vector<"u8">>>; nextEpochProofOfPossession: ToField<Option<Vector<"u8">>>; nextEpochNetworkPubkeyBytes: ToField<Option<Vector<"u8">>>; nextEpochWorkerPubkeyBytes: ToField<Option<Vector<"u8">>>; nextEpochNetAddress: ToField<Option<String>>; nextEpochP2PAddress: ToField<Option<String>>; nextEpochPrimaryAddress: ToField<Option<String>>; nextEpochWorkerAddress: ToField<Option<String>>; extraFields: ToField<Bag>
}
...
export class ValidatorMetadata implements StructClass {
    ...
    readonly suiAddress:
        ToField<"address">
    ; readonly protocolPubkeyBytes:
        ToField<Vector<"u8">>
    ; readonly networkPubkeyBytes:
        ToField<Vector<"u8">>
    ; readonly workerPubkeyBytes:
        ToField<Vector<"u8">>
    ; readonly proofOfPossession:
        ToField<Vector<"u8">>
    ; readonly name:
        ToField<String>
    ...
    ; readonly workerAddress:
        ToField<String>
    ; readonly nextEpochProtocolPubkeyBytes:
        ToField<Option<Vector<"u8">>>
    ; readonly nextEpochProofOfPossession:
        ToField<Option<Vector<"u8">>>
    ; readonly nextEpochNetworkPubkeyBytes:
        ToField<Option<Vector<"u8">>>
    ; readonly nextEpochWorkerPubkeyBytes:
        ToField<Option<Vector<"u8">>>
    ; readonly nextEpochNetAddress:
        ToField<Option<String>>
    ; readonly nextEpochP2PAddress:
        ToField<Option<String>>
    ; readonly nextEpochPrimaryAddress:
        ToField<Option<String>>
    ; readonly nextEpochWorkerAddress:
        ToField<Option<String>>
    ; readonly extraFields:
        ToField<Bag>
    ...
    static reified(): ValidatorMetadataReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                ValidatorMetadata.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                ValidatorMetadata.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                ValidatorMetadata.fromBcs(
                    data,
                ),
            bcs: ValidatorMetadata.bcs,
            fromJSONField: (field: any) =>
                ValidatorMetadata.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                ValidatorMetadata.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                ValidatorMetadata.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                ValidatorMetadata.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => ValidatorMetadata.fetch(
                client,
                id,
            ),
            new: (
                fields: ValidatorMetadataFields,
            ) => {
    ...
    static fromBcs(
        ...
        return ValidatorMetadata.fromFields(
            ValidatorMetadata.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return ValidatorMetadata.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return ValidatorMetadata.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return ValidatorMetadata.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return ValidatorMetadata.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ValidatorMetadata.fromSuiObjectData(
            res.data
        );
    }
}
