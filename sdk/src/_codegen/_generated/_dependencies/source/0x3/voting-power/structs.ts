...
export function isVotingPowerInfo(type: string): boolean {
    ...
    return type === `${PKG_V18}::voting_power::VotingPowerInfo`;
}

export interface VotingPowerInfoFields {
    validatorIndex: ToField<"u64">; votingPower: ToField<"u64">
}
...
export class VotingPowerInfo implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::voting_power::VotingPowerInfo`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = VotingPowerInfo.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::voting_power::VotingPowerInfo`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: VotingPowerInfoFields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::voting_power::VotingPowerInfo`;
    ...
    static reified(): VotingPowerInfoReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                VotingPowerInfo.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                VotingPowerInfo.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                VotingPowerInfo.fromBcs(
                    data,
                ),
            bcs: VotingPowerInfo.bcs,
            fromJSONField: (field: any) =>
                VotingPowerInfo.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                VotingPowerInfo.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                VotingPowerInfo.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: VotingPowerInfoFields,
            ) => {
                return new VotingPowerInfo(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return VotingPowerInfo.reified().new(
            {validatorIndex: decodeFromFields("u64", fields.validator_index), votingPower: decodeFromFields("u64", fields.voting_power)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return VotingPowerInfo.reified().new(
            {validatorIndex: decodeFromFieldsWithTypes("u64", item.fields.validator_index), votingPower: decodeFromFieldsWithTypes("u64", item.fields.voting_power)}
        )
    }
    ...
    static fromBcs(
        ...
        return VotingPowerInfo.fromFields(
            VotingPowerInfo.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return VotingPowerInfo.reified().new(
            {validatorIndex: decodeFromJSONField("u64", field.validatorIndex), votingPower: decodeFromJSONField("u64", field.votingPower)}
        )
    }
    ...
    static fromJSON(
        ...
        return VotingPowerInfo.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return VotingPowerInfo.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return VotingPowerInfo.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return VotingPowerInfo.fromSuiObjectData(
            res.data
        );
    }
}
...
export function isVotingPowerInfoV2(type: string): boolean {
    type = compressSuiType(type);
    return type === `${PKG_V18}::voting_power::VotingPowerInfoV2`;
}

export interface VotingPowerInfoV2Fields {
    validatorIndex: ToField<"u64">; votingPower: ToField<"u64">; stake: ToField<"u64">
}
...
export class VotingPowerInfoV2 implements StructClass {
    ...
    static readonly $typeName = `${PKG_V18}::voting_power::VotingPowerInfoV2`;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom = [] as const;

    readonly $typeName = VotingPowerInfoV2.$typeName;
    readonly $fullTypeName: `${typeof PKG_V18}::voting_power::VotingPowerInfoV2`;
    readonly $typeArgs: [];
    ...
    private constructor(typeArgs: [], fields: VotingPowerInfoV2Fields,
        ...
        this.$fullTypeName = composeSuiType(
            ...
            ...typeArgs
        ) as `${typeof PKG_V18}::voting_power::VotingPowerInfoV2`;
        this.$typeArgs = typeArgs;
    ...
    static reified(): VotingPowerInfoV2Reified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                VotingPowerInfoV2.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                VotingPowerInfoV2.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                VotingPowerInfoV2.fromBcs(
                    data,
                ),
            bcs: VotingPowerInfoV2.bcs,
            fromJSONField: (field: any) =>
                VotingPowerInfoV2.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                VotingPowerInfoV2.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                VotingPowerInfoV2.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: VotingPowerInfoV2Fields,
            ) => {
                return new VotingPowerInfoV2(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return VotingPowerInfoV2.reified().new(
            {validatorIndex: decodeFromFields("u64", fields.validator_index), votingPower: decodeFromFields("u64", fields.voting_power), stake: decodeFromFields("u64", fields.stake)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return VotingPowerInfoV2.reified().new(
            {validatorIndex: decodeFromFieldsWithTypes("u64", item.fields.validator_index), votingPower: decodeFromFieldsWithTypes("u64", item.fields.voting_power), stake: decodeFromFieldsWithTypes("u64", item.fields.stake)}
        )
    }
    ...
    static fromBcs(
        ...
        return VotingPowerInfoV2.fromFields(
            VotingPowerInfoV2.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return VotingPowerInfoV2.reified().new(
            {validatorIndex: decodeFromJSONField("u64", field.validatorIndex), votingPower: decodeFromJSONField("u64", field.votingPower), stake: decodeFromJSONField("u64", field.stake)}
        )
    }
    ...
    static fromJSON(
        ...
        return VotingPowerInfoV2.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return VotingPowerInfoV2.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return VotingPowerInfoV2.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return VotingPowerInfoV2.fromSuiObjectData(
            res.data
        );
    }
}
