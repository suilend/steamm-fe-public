...
export type Bytes20Reified = Reified<
    Bytes20,
    Bytes20Fields
>;
...
export class Bytes20 implements StructClass {
    ...
    static reified(): Bytes20Reified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Bytes20.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Bytes20.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Bytes20.fetch(
                client,
                id,
            ),
            new: (
                fields: Bytes20Fields,
            ) => {
                return new Bytes20(
                    [],
                    fields
    ...
    static fromBcs(
        ...
        return Bytes20.fromFields(
            Bytes20.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Bytes20.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return Bytes20.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return Bytes20.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Bytes20.fromSuiObjectData(
            res.data
        );
    }
}
