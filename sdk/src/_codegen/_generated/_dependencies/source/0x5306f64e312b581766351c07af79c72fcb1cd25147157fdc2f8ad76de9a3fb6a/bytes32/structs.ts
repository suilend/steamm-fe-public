...
export type Bytes32Reified = Reified<
    Bytes32,
    Bytes32Fields
>;
...
export class Bytes32 implements StructClass {
    ...
    static reified(): Bytes32Reified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Bytes32.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Bytes32.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Bytes32.fetch(
                client,
                id,
            ),
            new: (
                fields: Bytes32Fields,
            ) => {
                return new Bytes32(
                    [],
                    fields
    ...
    static fromBcs(
        ...
        return Bytes32.fromFields(
            Bytes32.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Bytes32.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return Bytes32.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return Bytes32.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Bytes32.fromSuiObjectData(
            res.data
        );
    }
}
