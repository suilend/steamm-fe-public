...
export type ConsumedVAAsReified = Reified<
    ConsumedVAAs,
    ConsumedVAAsFields
>;
...
export class ConsumedVAAs implements StructClass {
    ...
    static reified(): ConsumedVAAsReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                ConsumedVAAs.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                ConsumedVAAs.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                ConsumedVAAs.fromBcs(
                    data,
                ),
            bcs: ConsumedVAAs.bcs,
            fromJSONField: (field: any) =>
                ConsumedVAAs.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                ConsumedVAAs.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                ConsumedVAAs.fromSuiParsedData(
                    content,
                ),
    ...
    static fromBcs(
        ...
        return ConsumedVAAs.fromFields(
            ConsumedVAAs.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return ConsumedVAAs.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return ConsumedVAAs.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return ConsumedVAAs.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return ConsumedVAAs.fromSuiObjectData(
            res.data
        );
    }
}
