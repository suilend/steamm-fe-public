...
export class Cursor<T extends TypeArgument> implements StructClass {
    ...
    static reified<T extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Cursor.fromSuiParsedData(
                    T,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Cursor.fromSuiObjectData(
                    T,
                    content,
                ),
            ...
            new: (
                fields: CursorFields<ToTypeArgument<T>>,
            ) => {
                return new Cursor(
                    [extractType(T)],
                    fields
    ...
    static get bcs() {
        return <T extends BcsType<any>>(T: T) => bcs.struct(`Cursor<${T.name}>`, {
            data:
                bcs.vector(T)
    ...
    static fromJSON<T extends Reified<TypeArgument, any>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(Cursor.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return Cursor.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<T extends Reified<TypeArgument, any>>(
        ...
        return Cursor.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<T extends Reified<TypeArgument, any>>(
        ...
        if (data.content) {
            return Cursor.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends Reified<TypeArgument, any>>(
        ...
        return Cursor.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
