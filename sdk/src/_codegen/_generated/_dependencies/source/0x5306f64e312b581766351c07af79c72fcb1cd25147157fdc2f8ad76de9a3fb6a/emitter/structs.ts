...
export interface EmitterCapFields {
    id: ToField<UID>; sequence: ToField<"u64">
}

export type EmitterCapReified = Reified<
    EmitterCap,
    EmitterCapFields
>;
...
export class EmitterCap implements StructClass {
    ...
    static reified(): EmitterCapReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                EmitterCap.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                EmitterCap.fromFieldsWithTypes(
                    item,
                ),
    ...
    static fromFields(
        ...
        return EmitterCap.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), sequence: decodeFromFields("u64", fields.sequence)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return EmitterCap.reified().new(
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), sequence: decodeFromFieldsWithTypes("u64", item.fields.sequence)}
        )
    }
    ...
    static fromBcs(
        ...
        return EmitterCap.fromFields(
            EmitterCap.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return EmitterCap.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), sequence: decodeFromJSONField("u64", field.sequence)}
        )
    }
    ...
    static fromJSON(
        ...
        return EmitterCap.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return EmitterCap.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return EmitterCap.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return EmitterCap.fromSuiObjectData(
            res.data
        );
    }
}
...
export class EmitterCreated implements StructClass {
    ...
    static reified(): EmitterCreatedReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                EmitterCreated.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                EmitterCreated.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                EmitterCreated.fromBcs(
                    data,
                ),
            bcs: EmitterCreated.bcs,
            fromJSONField: (field: any) =>
                EmitterCreated.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                EmitterCreated.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                EmitterCreated.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: EmitterCreatedFields,
            ) => {
                return new EmitterCreated(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return EmitterCreated.fromFields(
            EmitterCreated.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return EmitterCreated.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return EmitterCreated.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return EmitterCreated.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return EmitterCreated.fromSuiObjectData(
            res.data
        );
    }
}
...
export class EmitterDestroyed implements StructClass {
    ...
    static reified(): EmitterDestroyedReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                EmitterDestroyed.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                EmitterDestroyed.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                EmitterDestroyed.fromBcs(
                    data,
                ),
            bcs: EmitterDestroyed.bcs,
            fromJSONField: (field: any) =>
                EmitterDestroyed.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                EmitterDestroyed.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                EmitterDestroyed.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromBcs(
        ...
        return EmitterDestroyed.fromFields(
            EmitterDestroyed.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return EmitterDestroyed.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return EmitterDestroyed.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return EmitterDestroyed.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return EmitterDestroyed.fromSuiObjectData(
            res.data
        );
    }
}
