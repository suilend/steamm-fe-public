...
export interface FeeCollectorFields {
    feeAmount: ToField<"u64">; balance: ToField<Balance<ToPhantom<SUI>>>
}

export type FeeCollectorReified = Reified<
    FeeCollector,
    FeeCollectorFields
>;
...
export class FeeCollector implements StructClass {
    ...
    static reified(): FeeCollectorReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                FeeCollector.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                FeeCollector.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                FeeCollector.fromBcs(
                    data,
                ),
            bcs: FeeCollector.bcs,
            fromJSONField: (field: any) =>
                FeeCollector.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                FeeCollector.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                FeeCollector.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                FeeCollector.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => FeeCollector.fetch(
                client,
                id,
            ),
            new: (
                fields: FeeCollectorFields,
            ) => {
    ...
    static fromFields(
        ...
        return FeeCollector.reified().new(
            {feeAmount: decodeFromFields("u64", fields.fee_amount), balance: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.balance)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return FeeCollector.reified().new(
            {feeAmount: decodeFromFieldsWithTypes("u64", item.fields.fee_amount), balance: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.balance)}
        )
    }
    ...
    static fromBcs(
        ...
        return FeeCollector.fromFields(
            FeeCollector.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return FeeCollector.reified().new(
            {feeAmount: decodeFromJSONField("u64", field.feeAmount), balance: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.balance)}
        )
    }
    ...
    static fromJSON(
        ...
        return FeeCollector.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return FeeCollector.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return FeeCollector.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return FeeCollector.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return FeeCollector.fromSuiObjectData(
            res.data
        );
    }
}
