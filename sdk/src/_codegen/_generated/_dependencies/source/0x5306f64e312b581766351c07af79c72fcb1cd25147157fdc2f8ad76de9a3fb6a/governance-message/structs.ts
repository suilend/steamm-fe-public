...
export interface DecreeReceiptFields<T extends PhantomTypeArgument> {
    payload: ToField<Vector<"u8">>; digest: ToField<Bytes32>; sequence: ToField<"u64">
}
...
export class DecreeReceipt<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                DecreeReceipt.fromFields(
                    T,
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                DecreeReceipt.fromFieldsWithTypes(
                    T,
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                DecreeReceipt.fromBcs(
                    T,
                    data,
                ),
            bcs: DecreeReceipt.bcs,
            fromJSONField: (field: any) =>
                DecreeReceipt.fromJSONField(
                    T,
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                DecreeReceipt.fromJSON(
                    T,
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                DecreeReceipt.fromSuiParsedData(
                    T,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                DecreeReceipt.fromSuiObjectData(
                    T,
                    content,
                ),
            ...
            new: (
                fields: DecreeReceiptFields<ToPhantomTypeArgument<T>>,
            ) => {
                return new DecreeReceipt(
                    [extractType(T)],
                    fields
                )
            },
    ...
    static phantom<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return phantom(DecreeReceipt.reified(
            T
        ));
    }
    ...
    static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeReceipt.reified(
            ...
            {payload: decodeFromFields(reified.vector("u8"), fields.payload), digest: decodeFromFields(Bytes32.reified(), fields.digest), sequence: decodeFromFields("u64", fields.sequence)}
        )
    }
    ...
    static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeReceipt.reified(
            ...
            {payload: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.payload), digest: decodeFromFieldsWithTypes(Bytes32.reified(), item.fields.digest), sequence: decodeFromFieldsWithTypes("u64", item.fields.sequence)}
        )
    }
    ...
    static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeReceipt.fromFields(
            typeArg,
            DecreeReceipt.bcs.parse(data)
        )
    }
    ...
    static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeReceipt.reified(
            ...
            {payload: decodeFromJSONField(reified.vector("u8"), field.payload), digest: decodeFromJSONField(Bytes32.reified(), field.digest), sequence: decodeFromJSONField("u64", field.sequence)}
        )
    }
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(DecreeReceipt.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return DecreeReceipt.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeReceipt.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return DecreeReceipt.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeReceipt.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export interface DecreeTicketFields<T extends PhantomTypeArgument> {
    governanceChain: ToField<"u16">; governanceContract: ToField<ExternalAddress>; moduleName: ToField<Bytes32>; action: ToField<"u8">; global: ToField<"bool">
}
...
export class DecreeTicket<T extends PhantomTypeArgument> implements StructClass {
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                DecreeTicket.fromFieldsWithTypes(
                    T,
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                DecreeTicket.fromBcs(
                    T,
                    data,
                ),
            bcs: DecreeTicket.bcs,
            fromJSONField: (field: any) =>
                DecreeTicket.fromJSONField(
                    T,
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                DecreeTicket.fromJSON(
                    T,
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                DecreeTicket.fromSuiParsedData(
                    T,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                DecreeTicket.fromSuiObjectData(
                    T,
                    content,
                ),
            ...
            new: (
                fields: DecreeTicketFields<ToPhantomTypeArgument<T>>,
            ) => {
                return new DecreeTicket(
                    [extractType(T)],
                    fields
                )
            },
    ...
    static phantom<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return phantom(DecreeTicket.reified(
            T
        ));
    }
    ...
    static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeTicket.reified(
            ...
            {governanceChain: decodeFromFields("u16", fields.governance_chain), governanceContract: decodeFromFields(ExternalAddress.reified(), fields.governance_contract), moduleName: decodeFromFields(Bytes32.reified(), fields.module_name), action: decodeFromFields("u8", fields.action), global: decodeFromFields("bool", fields.global)}
        )
    }
    ...
    static fromBcs<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeTicket.fromFields(
            typeArg,
            DecreeTicket.bcs.parse(data)
        )
    }
    ...
    static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeTicket.reified(
            ...
            {governanceChain: decodeFromJSONField("u16", field.governanceChain), governanceContract: decodeFromJSONField(ExternalAddress.reified(), field.governanceContract), moduleName: decodeFromJSONField(Bytes32.reified(), field.moduleName), action: decodeFromJSONField("u8", field.action), global: decodeFromJSONField("bool", field.global)}
        )
    }
    ...
    static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(DecreeTicket.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return DecreeTicket.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return DecreeTicket.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return DecreeTicket.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
