...
export interface GuardianSetFields {
    index: ToField<"u32">; guardians: ToField<Vector<Guardian>>; expirationTimestampMs: ToField<"u64">
}

export type GuardianSetReified = Reified<
    GuardianSet,
    GuardianSetFields
>;
...
export class GuardianSet implements StructClass {
    ...
    ; readonly expirationTimestampMs:
        ToField<"u64">
    ...
    static reified(): GuardianSetReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                GuardianSet.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GuardianSet.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromJSONField: (field: any) =>
                GuardianSet.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GuardianSet.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GuardianSet.fromSuiParsedData(
                    content,
                ),
    ...
    static fromFields(
        ...
        return GuardianSet.reified().new(
            {index: decodeFromFields("u32", fields.index), guardians: decodeFromFields(reified.vector(Guardian.reified()), fields.guardians), expirationTimestampMs: decodeFromFields("u64", fields.expiration_timestamp_ms)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return GuardianSet.reified().new(
            {index: decodeFromFieldsWithTypes("u32", item.fields.index), guardians: decodeFromFieldsWithTypes(reified.vector(Guardian.reified()), item.fields.guardians), expirationTimestampMs: decodeFromFieldsWithTypes("u64", item.fields.expiration_timestamp_ms)}
        )
    }
    ...
    static fromBcs(
        ...
        return GuardianSet.fromFields(
            GuardianSet.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return GuardianSet.reified().new(
            {index: decodeFromJSONField("u32", field.index), guardians: decodeFromJSONField(reified.vector(Guardian.reified()), field.guardians), expirationTimestampMs: decodeFromJSONField("u64", field.expirationTimestampMs)}
        )
    }
    ...
    static fromJSON(
        ...
        return GuardianSet.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GuardianSet.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GuardianSet.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GuardianSet.fromSuiObjectData(
            res.data
        );
    }
}
