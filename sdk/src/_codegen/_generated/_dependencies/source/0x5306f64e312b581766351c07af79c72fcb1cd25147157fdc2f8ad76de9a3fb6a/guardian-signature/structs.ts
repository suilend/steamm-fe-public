...
export interface GuardianSignatureFields {
    r: ToField<Bytes32>; s: ToField<Bytes32>; recoveryId: ToField<"u8">; index: ToField<"u8">
}
...
export class GuardianSignature implements StructClass {
    ...
    static reified(): GuardianSignatureReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                GuardianSignature.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GuardianSignature.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GuardianSignature.fromBcs(
                    data,
                ),
            ...
            fromJSON: (json: Record<string, any>) =>
                GuardianSignature.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GuardianSignature.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                GuardianSignature.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => GuardianSignature.fetch(
                client,
                id,
            ),
            new: (
                fields: GuardianSignatureFields,
            ) => {
    ...
    static fromFields(
        ...
        return GuardianSignature.reified().new(
            {r: decodeFromFields(Bytes32.reified(), fields.r), s: decodeFromFields(Bytes32.reified(), fields.s), recoveryId: decodeFromFields("u8", fields.recovery_id), index: decodeFromFields("u8", fields.index)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return GuardianSignature.reified().new(
            {r: decodeFromFieldsWithTypes(Bytes32.reified(), item.fields.r), s: decodeFromFieldsWithTypes(Bytes32.reified(), item.fields.s), recoveryId: decodeFromFieldsWithTypes("u8", item.fields.recovery_id), index: decodeFromFieldsWithTypes("u8", item.fields.index)}
        )
    }
    ...
    static fromBcs(
        ...
        return GuardianSignature.fromFields(
            GuardianSignature.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return GuardianSignature.reified().new(
            {r: decodeFromJSONField(Bytes32.reified(), field.r), s: decodeFromJSONField(Bytes32.reified(), field.s), recoveryId: decodeFromJSONField("u8", field.recoveryId), index: decodeFromJSONField("u8", field.index)}
        )
    }
    ...
    static fromJSON(
        ...
        return GuardianSignature.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GuardianSignature.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return GuardianSignature.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return GuardianSignature.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GuardianSignature.fromSuiObjectData(
            res.data
        );
    }
}
