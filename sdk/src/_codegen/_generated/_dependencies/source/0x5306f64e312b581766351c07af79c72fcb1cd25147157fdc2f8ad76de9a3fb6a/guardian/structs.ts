...
export type GuardianReified = Reified<
    Guardian,
    GuardianFields
>;
...
export class Guardian implements StructClass {
    ...
    static reified(): GuardianReified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Guardian.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Guardian.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Guardian.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromBcs(
        ...
        return Guardian.fromFields(
            Guardian.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Guardian.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return Guardian.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return Guardian.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Guardian.fromSuiObjectData(
            res.data
        );
    }
}
