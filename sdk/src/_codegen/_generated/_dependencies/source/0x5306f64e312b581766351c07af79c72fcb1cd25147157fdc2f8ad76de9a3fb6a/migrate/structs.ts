...
export class MigrateComplete implements StructClass {
    ...
    static reified(): MigrateCompleteReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                MigrateComplete.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                MigrateComplete.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                MigrateComplete.fromBcs(
                    data,
                ),
            bcs: MigrateComplete.bcs,
            fromJSONField: (field: any) =>
                MigrateComplete.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                MigrateComplete.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                MigrateComplete.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                MigrateComplete.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => MigrateComplete.fetch(
                client,
                id,
            ),
            new: (
                fields: MigrateCompleteFields,
            ) => {
    ...
    static fromBcs(
        ...
        return MigrateComplete.fromFields(
            MigrateComplete.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return MigrateComplete.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return MigrateComplete.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return MigrateComplete.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return MigrateComplete.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return MigrateComplete.fromSuiObjectData(
            res.data
        );
    }
}
