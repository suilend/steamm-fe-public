...
export interface MessageTicketFields {
    sender: ToField<ID>; sequence: ToField<"u64">; nonce: ToField<"u32">; payload: ToField<Vector<"u8">>
}

export type MessageTicketReified = Reified<
    MessageTicket,
    MessageTicketFields
>;
...
export class MessageTicket implements StructClass {
    ...
    static reified(): MessageTicketReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                MessageTicket.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                MessageTicket.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                MessageTicket.fromBcs(
                    data,
                ),
            bcs: MessageTicket.bcs,
            fromJSONField: (field: any) =>
                MessageTicket.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                MessageTicket.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                MessageTicket.fromSuiParsedData(
                    content,
                ),
    ...
    static fromFields(
        ...
        return MessageTicket.reified().new(
            {sender: decodeFromFields(ID.reified(), fields.sender), sequence: decodeFromFields("u64", fields.sequence), nonce: decodeFromFields("u32", fields.nonce), payload: decodeFromFields(reified.vector("u8"), fields.payload)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return MessageTicket.reified().new(
            {sender: decodeFromFieldsWithTypes(ID.reified(), item.fields.sender), sequence: decodeFromFieldsWithTypes("u64", item.fields.sequence), nonce: decodeFromFieldsWithTypes("u32", item.fields.nonce), payload: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.payload)}
        )
    }
    ...
    static fromBcs(
        ...
        return MessageTicket.fromFields(
            MessageTicket.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return MessageTicket.reified().new(
            {sender: decodeFromJSONField(ID.reified(), field.sender), sequence: decodeFromJSONField("u64", field.sequence), nonce: decodeFromJSONField("u32", field.nonce), payload: decodeFromJSONField(reified.vector("u8"), field.payload)}
        )
    }
    ...
    static fromJSON(
        ...
        return MessageTicket.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return MessageTicket.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return MessageTicket.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return MessageTicket.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface WormholeMessageFields {
    sender: ToField<ID>; sequence: ToField<"u64">; nonce: ToField<"u32">; payload: ToField<Vector<"u8">>; consistencyLevel: ToField<"u8">; timestamp: ToField<"u64">
}
...
export class WormholeMessage implements StructClass {
    ...
    static reified(): WormholeMessageReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                WormholeMessage.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                WormholeMessage.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                WormholeMessage.fromBcs(
                    data,
                ),
            bcs: WormholeMessage.bcs,
            fromJSONField: (field: any) =>
                WormholeMessage.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                WormholeMessage.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                WormholeMessage.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromFields(
        ...
        return WormholeMessage.reified().new(
            {sender: decodeFromFields(ID.reified(), fields.sender), sequence: decodeFromFields("u64", fields.sequence), nonce: decodeFromFields("u32", fields.nonce), payload: decodeFromFields(reified.vector("u8"), fields.payload), consistencyLevel: decodeFromFields("u8", fields.consistency_level), timestamp: decodeFromFields("u64", fields.timestamp)}
        )
    }
    ...
    static fromBcs(
        ...
        return WormholeMessage.fromFields(
            WormholeMessage.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return WormholeMessage.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return WormholeMessage.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return WormholeMessage.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return WormholeMessage.fromSuiObjectData(
            res.data
        );
    }
}
