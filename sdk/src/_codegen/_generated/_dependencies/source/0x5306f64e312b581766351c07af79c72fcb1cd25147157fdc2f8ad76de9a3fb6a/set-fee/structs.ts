...
export type SetFeeReified = Reified<
    SetFee,
    SetFeeFields
>;
...
export class SetFee implements StructClass {
    ...
    static fromBcs(
        ...
        return SetFee.fromFields(
            SetFee.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return SetFee.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return SetFee.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return SetFee.fromSuiObjectData(
            res.data
        );
    }
}
