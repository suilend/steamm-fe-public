...
export type EmptyReified = Reified<
    Empty,
    EmptyFields
>;
...
export class Empty implements StructClass {
    ...
    static fromBcs(
        ...
        return Empty.fromFields(
            Empty.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Empty.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Empty.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Empty.fromSuiObjectData(
            res.data
        );
    }
}
...
export class Set<T extends PhantomTypeArgument> implements StructClass {
    ...
    readonly items:
        ToField<Table<T, ToPhantom<Empty>>>
    ...
    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            new: (
                fields: SetFields<ToPhantomTypeArgument<T>>,
            ) => {
                return new Set(
                    [extractType(T)],
                    fields
