...
export type DeployerCapReified = Reified<
    DeployerCap,
    DeployerCapFields
>;
...
export class DeployerCap implements StructClass {
    ...
    static reified(): DeployerCapReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                DeployerCap.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                DeployerCap.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromJSONField: (field: any) =>
                DeployerCap.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                DeployerCap.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                DeployerCap.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: DeployerCapFields,
            ) => {
                return new DeployerCap(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return DeployerCap.fromFields(
            DeployerCap.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return DeployerCap.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return DeployerCap.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return DeployerCap.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return DeployerCap.fromSuiObjectData(
            res.data
        );
    }
}
