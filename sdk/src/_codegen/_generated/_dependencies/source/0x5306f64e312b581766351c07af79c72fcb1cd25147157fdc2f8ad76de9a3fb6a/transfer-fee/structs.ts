...
export interface TransferFeeFields {
    amount: ToField<"u64">; recipient: ToField<"address">
}

export type TransferFeeReified = Reified<
    TransferFee,
    TransferFeeFields
>;
...
export class TransferFee implements StructClass {
    ...
    static reified(): TransferFeeReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                TransferFee.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                TransferFee.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                TransferFee.fromBcs(
            ...
            bcs: TransferFee.bcs,
            fromJSONField: (field: any) =>
                TransferFee.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                TransferFee.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                TransferFee.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromFields(
        ...
        return TransferFee.reified().new(
            {amount: decodeFromFields("u64", fields.amount), recipient: decodeFromFields("address", fields.recipient)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return TransferFee.reified().new(
            {amount: decodeFromFieldsWithTypes("u64", item.fields.amount), recipient: decodeFromFieldsWithTypes("address", item.fields.recipient)}
        )
    }
    ...
    static fromJSONField(
        ...
        return TransferFee.reified().new(
            {amount: decodeFromJSONField("u64", field.amount), recipient: decodeFromJSONField("address", field.recipient)}
        )
    }
    ...
    static fromJSON(
        ...
        return TransferFee.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return TransferFee.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return TransferFee.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return TransferFee.fromSuiObjectData(
            res.data
        );
    }
}
