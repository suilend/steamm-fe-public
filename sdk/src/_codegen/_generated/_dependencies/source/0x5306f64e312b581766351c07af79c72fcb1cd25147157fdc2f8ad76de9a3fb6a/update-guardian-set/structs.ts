...
export class GovernanceWitness implements StructClass {
    ...
    static reified(): GovernanceWitnessReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                GovernanceWitness.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GovernanceWitness.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GovernanceWitness.fromBcs(
                    data,
                ),
            bcs: GovernanceWitness.bcs,
            fromJSONField: (field: any) =>
                GovernanceWitness.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GovernanceWitness.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GovernanceWitness.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: GovernanceWitnessFields,
            ) => {
                return new GovernanceWitness(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return GovernanceWitness.fromFields(
            GovernanceWitness.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return GovernanceWitness.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GovernanceWitness.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GovernanceWitness.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GovernanceWitness.fromSuiObjectData(
            res.data
        );
    }
}
...
export class GuardianSetAdded implements StructClass {
    ...
    static reified(): GuardianSetAddedReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                GuardianSetAdded.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GuardianSetAdded.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GuardianSetAdded.fromBcs(
                    data,
                ),
            bcs: GuardianSetAdded.bcs,
            fromJSONField: (field: any) =>
                GuardianSetAdded.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GuardianSetAdded.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GuardianSetAdded.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: GuardianSetAddedFields,
            ) => {
                return new GuardianSetAdded(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return GuardianSetAdded.fromFields(
            GuardianSetAdded.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return GuardianSetAdded.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GuardianSetAdded.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GuardianSetAdded.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GuardianSetAdded.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface UpdateGuardianSetFields {
    newIndex: ToField<"u32">; guardians: ToField<Vector<Guardian>>
}
...
export class UpdateGuardianSet implements StructClass {
    ...
    static reified(): UpdateGuardianSetReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                UpdateGuardianSet.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                UpdateGuardianSet.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                UpdateGuardianSet.fromBcs(
                    data,
                ),
            bcs: UpdateGuardianSet.bcs,
            fromJSONField: (field: any) =>
                UpdateGuardianSet.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                UpdateGuardianSet.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                UpdateGuardianSet.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: UpdateGuardianSetFields,
            ) => {
    ...
    static fromFields(
        ...
        return UpdateGuardianSet.reified().new(
            {newIndex: decodeFromFields("u32", fields.new_index), guardians: decodeFromFields(reified.vector(Guardian.reified()), fields.guardians)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return UpdateGuardianSet.reified().new(
            {newIndex: decodeFromFieldsWithTypes("u32", item.fields.new_index), guardians: decodeFromFieldsWithTypes(reified.vector(Guardian.reified()), item.fields.guardians)}
        )
    }
    ...
    static fromBcs(
        ...
        return UpdateGuardianSet.fromFields(
            UpdateGuardianSet.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return UpdateGuardianSet.reified().new(
            {newIndex: decodeFromJSONField("u32", field.newIndex), guardians: decodeFromJSONField(reified.vector(Guardian.reified()), field.guardians)}
        )
    }
    ...
    static fromJSON(
        ...
        return UpdateGuardianSet.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return UpdateGuardianSet.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return UpdateGuardianSet.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UpdateGuardianSet.fromSuiObjectData(
            res.data
        );
    }
}
