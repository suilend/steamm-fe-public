...
export interface VAAFields {
    guardianSetIndex: ToField<"u32">; timestamp: ToField<"u32">; nonce: ToField<"u32">; emitterChain: ToField<"u16">; emitterAddress: ToField<ExternalAddress>; sequence: ToField<"u64">; consistencyLevel: ToField<"u8">; payload: ToField<Vector<"u8">>; digest: ToField<Bytes32>
}

export type VAAReified = Reified<
    VAA,
    VAAFields
>;
...
export class VAA implements StructClass {
    ...
    ; readonly nonce:
        ToField<"u32">
    ; readonly emitterChain:
        ToField<"u16">
    ; readonly emitterAddress:
    ...
    static fromFields(
        ...
        return VAA.reified().new(
            {guardianSetIndex: decodeFromFields("u32", fields.guardian_set_index), timestamp: decodeFromFields("u32", fields.timestamp), nonce: decodeFromFields("u32", fields.nonce), emitterChain: decodeFromFields("u16", fields.emitter_chain), emitterAddress: decodeFromFields(ExternalAddress.reified(), fields.emitter_address), sequence: decodeFromFields("u64", fields.sequence), consistencyLevel: decodeFromFields("u8", fields.consistency_level), payload: decodeFromFields(reified.vector("u8"), fields.payload), digest: decodeFromFields(Bytes32.reified(), fields.digest)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return VAA.reified().new(
            {guardianSetIndex: decodeFromFieldsWithTypes("u32", item.fields.guardian_set_index), timestamp: decodeFromFieldsWithTypes("u32", item.fields.timestamp), nonce: decodeFromFieldsWithTypes("u32", item.fields.nonce), emitterChain: decodeFromFieldsWithTypes("u16", item.fields.emitter_chain), emitterAddress: decodeFromFieldsWithTypes(ExternalAddress.reified(), item.fields.emitter_address), sequence: decodeFromFieldsWithTypes("u64", item.fields.sequence), consistencyLevel: decodeFromFieldsWithTypes("u8", item.fields.consistency_level), payload: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.payload), digest: decodeFromFieldsWithTypes(Bytes32.reified(), item.fields.digest)}
        )
    }
    ...
    static fromJSONField(
        ...
        return VAA.reified().new(
            {guardianSetIndex: decodeFromJSONField("u32", field.guardianSetIndex), timestamp: decodeFromJSONField("u32", field.timestamp), nonce: decodeFromJSONField("u32", field.nonce), emitterChain: decodeFromJSONField("u16", field.emitterChain), emitterAddress: decodeFromJSONField(ExternalAddress.reified(), field.emitterAddress), sequence: decodeFromJSONField("u64", field.sequence), consistencyLevel: decodeFromJSONField("u8", field.consistencyLevel), payload: decodeFromJSONField(reified.vector("u8"), field.payload), digest: decodeFromJSONField(Bytes32.reified(), field.digest)}
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return VAA.fromFieldsWithTypes(
            content
        );
    }
