...
export type V__0_2_0Reified = Reified<
    V__0_2_0,
    V__0_2_0Fields
>;
...
export class V__0_2_0 implements StructClass {
    ...
    static fromBcs(
        ...
        return V__0_2_0.fromFields(
            V__0_2_0.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return V__0_2_0.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return V__0_2_0.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return V__0_2_0.fromSuiObjectData(
            res.data
        );
    }
}
