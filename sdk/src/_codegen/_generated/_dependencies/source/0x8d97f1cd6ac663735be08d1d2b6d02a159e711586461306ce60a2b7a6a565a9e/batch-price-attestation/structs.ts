...
export interface BatchPriceAttestationFields {
    header: ToField<Header>; attestationSize: ToField<"u64">; attestationCount: ToField<"u64">; priceInfos: ToField<Vector<PriceInfo>>
}
...
export class BatchPriceAttestation implements StructClass {
    ...
    readonly header:
        ToField<Header>
    ; readonly attestationSize:
        ToField<"u64">
    ; readonly attestationCount:
        ToField<"u64">
    ; readonly priceInfos:
        ToField<Vector<PriceInfo>>
    ...
    static reified(): BatchPriceAttestationReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                BatchPriceAttestation.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                BatchPriceAttestation.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                BatchPriceAttestation.fromBcs(
                    data,
                ),
            bcs: BatchPriceAttestation.bcs,
            fromJSONField: (field: any) =>
                BatchPriceAttestation.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                BatchPriceAttestation.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                BatchPriceAttestation.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: BatchPriceAttestationFields,
            ) => {
    ...
    static fromFields(
        ...
        return BatchPriceAttestation.reified().new(
            {header: decodeFromFields(Header.reified(), fields.header), attestationSize: decodeFromFields("u64", fields.attestation_size), attestationCount: decodeFromFields("u64", fields.attestation_count), priceInfos: decodeFromFields(reified.vector(PriceInfo.reified()), fields.price_infos)}
        )
    }
    ...
    static fromJSONField(
        ...
        return BatchPriceAttestation.reified().new(
            {header: decodeFromJSONField(Header.reified(), field.header), attestationSize: decodeFromJSONField("u64", field.attestationSize), attestationCount: decodeFromJSONField("u64", field.attestationCount), priceInfos: decodeFromJSONField(reified.vector(PriceInfo.reified()), field.priceInfos)}
        )
    }
    ...
    static fromJSON(
        ...
        return BatchPriceAttestation.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return BatchPriceAttestation.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return BatchPriceAttestation.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return BatchPriceAttestation.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface HeaderFields {
    magic: ToField<"u64">; versionMajor: ToField<"u64">; versionMinor: ToField<"u64">; headerSize: ToField<"u64">; payloadId: ToField<"u8">
}

export type HeaderReified = Reified<
    Header,
    HeaderFields
>;
...
export class Header implements StructClass {
    ...
    static fromFields(
        ...
        return Header.reified().new(
            {magic: decodeFromFields("u64", fields.magic), versionMajor: decodeFromFields("u64", fields.version_major), versionMinor: decodeFromFields("u64", fields.version_minor), headerSize: decodeFromFields("u64", fields.header_size), payloadId: decodeFromFields("u8", fields.payload_id)}
        )
    }
    ...
    static fromJSONField(
        ...
        return Header.reified().new(
            {magic: decodeFromJSONField("u64", field.magic), versionMajor: decodeFromJSONField("u64", field.versionMajor), versionMinor: decodeFromJSONField("u64", field.versionMinor), headerSize: decodeFromJSONField("u64", field.headerSize), payloadId: decodeFromJSONField("u8", field.payloadId)}
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Header.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Header.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Header.fromSuiObjectData(
            res.data
        );
    }
}
