...
export interface DataSourceFields {
    emitterChain: ToField<"u64">; emitterAddress: ToField<ExternalAddress>
}

export type DataSourceReified = Reified<
    DataSource,
    DataSourceFields
>;
...
export class DataSource implements StructClass {
    ...
    static reified(): DataSourceReified {
        return {
            ...
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                DataSource.fromFieldsWithTypes(
                    item,
                ),
    ...
    static fromFields(
        ...
        return DataSource.reified().new(
            {emitterChain: decodeFromFields("u64", fields.emitter_chain), emitterAddress: decodeFromFields(ExternalAddress.reified(), fields.emitter_address)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return DataSource.reified().new(
            {emitterChain: decodeFromFieldsWithTypes("u64", item.fields.emitter_chain), emitterAddress: decodeFromFieldsWithTypes(ExternalAddress.reified(), item.fields.emitter_address)}
        )
    }
    ...
    static fromBcs(
        ...
        return DataSource.fromFields(
            DataSource.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return DataSource.reified().new(
            {emitterChain: decodeFromJSONField("u64", field.emitterChain), emitterAddress: decodeFromJSONField(ExternalAddress.reified(), field.emitterAddress)}
        )
    }
    ...
    static fromJSON(
        ...
        return DataSource.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return DataSource.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return DataSource.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return DataSource.fromSuiObjectData(
            res.data
        );
    }
}
