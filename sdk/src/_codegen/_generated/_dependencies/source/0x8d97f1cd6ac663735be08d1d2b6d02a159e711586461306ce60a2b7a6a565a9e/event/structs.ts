...
export interface PriceFeedUpdateEventFields {
    priceFeed: ToField<PriceFeed>; timestamp: ToField<"u64">
}
...
export class PriceFeedUpdateEvent implements StructClass {
    ...
    static reified(): PriceFeedUpdateEventReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                PriceFeedUpdateEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PriceFeedUpdateEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                PriceFeedUpdateEvent.fromBcs(
                    data,
                ),
            bcs: PriceFeedUpdateEvent.bcs,
            fromJSONField: (field: any) =>
                PriceFeedUpdateEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PriceFeedUpdateEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PriceFeedUpdateEvent.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: PriceFeedUpdateEventFields,
            ) => {
    ...
    static fromFields(
        ...
        return PriceFeedUpdateEvent.reified().new(
            {priceFeed: decodeFromFields(PriceFeed.reified(), fields.price_feed), timestamp: decodeFromFields("u64", fields.timestamp)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return PriceFeedUpdateEvent.reified().new(
            {priceFeed: decodeFromFieldsWithTypes(PriceFeed.reified(), item.fields.price_feed), timestamp: decodeFromFieldsWithTypes("u64", item.fields.timestamp)}
        )
    }
    ...
    static fromJSONField(
        ...
        return PriceFeedUpdateEvent.reified().new(
            {priceFeed: decodeFromJSONField(PriceFeed.reified(), field.priceFeed), timestamp: decodeFromJSONField("u64", field.timestamp)}
        )
    }
    ...
    static fromJSON(
        ...
        return PriceFeedUpdateEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PriceFeedUpdateEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PriceFeedUpdateEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PriceFeedUpdateEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export class PythInitializationEvent implements StructClass {
    ...
    static reified(): PythInitializationEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                PythInitializationEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PythInitializationEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                PythInitializationEvent.fromBcs(
                    data,
                ),
            bcs: PythInitializationEvent.bcs,
            fromJSONField: (field: any) =>
                PythInitializationEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PythInitializationEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PythInitializationEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: PythInitializationEventFields,
            ) => {
                return new PythInitializationEvent(
                    [],
                    fields
                )
            },
    ...
    static fromJSON(
        ...
        return PythInitializationEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PythInitializationEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PythInitializationEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PythInitializationEvent.fromSuiObjectData(
            res.data
        );
    }
}
