...
export class GovernanceAction implements StructClass {
    ...
    static reified(): GovernanceActionReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                GovernanceAction.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GovernanceAction.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GovernanceAction.fromBcs(
                    data,
                ),
            bcs: GovernanceAction.bcs,
            fromJSONField: (field: any) =>
                GovernanceAction.fromJSONField(
                    field,
                ),
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                GovernanceAction.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                GovernanceAction.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => GovernanceAction.fetch(
                client,
                id,
            ),
            new: (
                fields: GovernanceActionFields,
            ) => {
    ...
    static fromBcs(
        ...
        return GovernanceAction.fromFields(
            GovernanceAction.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return GovernanceAction.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GovernanceAction.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return GovernanceAction.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return GovernanceAction.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GovernanceAction.fromSuiObjectData(
            res.data
        );
    }
}
