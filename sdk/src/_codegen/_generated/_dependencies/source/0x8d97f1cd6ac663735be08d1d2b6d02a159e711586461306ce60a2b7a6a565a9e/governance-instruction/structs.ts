...
export interface GovernanceInstructionFields {
    module: ToField<"u8">; action: ToField<GovernanceAction>; targetChainId: ToField<"u64">; payload: ToField<Vector<"u8">>
}
...
export class GovernanceInstruction implements StructClass {
    ...
    readonly module:
        ToField<"u8">
    ; readonly action:
        ToField<GovernanceAction>
    ; readonly targetChainId:
        ToField<"u64">
    ; readonly payload:
        ToField<Vector<"u8">>
    ...
    static reified(): GovernanceInstructionReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                GovernanceInstruction.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GovernanceInstruction.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GovernanceInstruction.fromBcs(
                    data,
                ),
            bcs: GovernanceInstruction.bcs,
            fromJSONField: (field: any) =>
                GovernanceInstruction.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GovernanceInstruction.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GovernanceInstruction.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: GovernanceInstructionFields,
            ) => {
    ...
    static fromFields(
        ...
        return GovernanceInstruction.reified().new(
            {module: decodeFromFields("u8", fields.module_), action: decodeFromFields(GovernanceAction.reified(), fields.action), targetChainId: decodeFromFields("u64", fields.target_chain_id), payload: decodeFromFields(reified.vector("u8"), fields.payload)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return GovernanceInstruction.reified().new(
            {module: decodeFromFieldsWithTypes("u8", item.fields.module_), action: decodeFromFieldsWithTypes(GovernanceAction.reified(), item.fields.action), targetChainId: decodeFromFieldsWithTypes("u64", item.fields.target_chain_id), payload: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.payload)}
        )
    }
    ...
    static fromJSONField(
        ...
        return GovernanceInstruction.reified().new(
            {module: decodeFromJSONField("u8", field.module), action: decodeFromJSONField(GovernanceAction.reified(), field.action), targetChainId: decodeFromJSONField("u64", field.targetChainId), payload: decodeFromJSONField(reified.vector("u8"), field.payload)}
        )
    }
    ...
    static fromJSON(
        ...
        return GovernanceInstruction.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GovernanceInstruction.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GovernanceInstruction.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GovernanceInstruction.fromSuiObjectData(
            res.data
        );
    }
}
