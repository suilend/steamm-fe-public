...
export class WormholeVAAVerificationReceipt implements StructClass {
    ...
    static reified(): WormholeVAAVerificationReceiptReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                WormholeVAAVerificationReceipt.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                WormholeVAAVerificationReceipt.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                WormholeVAAVerificationReceipt.fromBcs(
                    data,
                ),
            bcs: WormholeVAAVerificationReceipt.bcs,
            fromJSONField: (field: any) =>
                WormholeVAAVerificationReceipt.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                WormholeVAAVerificationReceipt.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                WormholeVAAVerificationReceipt.fromSuiParsedData(
                    content,
                ),
    ...
    static fromJSON(
        ...
        return WormholeVAAVerificationReceipt.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return WormholeVAAVerificationReceipt.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return WormholeVAAVerificationReceipt.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return WormholeVAAVerificationReceipt.fromSuiObjectData(
            res.data
        );
    }
}
