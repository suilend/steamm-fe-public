...
export interface I64Fields {
    negative: ToField<"bool">; magnitude: ToField<"u64">
}
...
export class I64 implements StructClass {
    ...
    static fromFields(
        ...
        return I64.reified().new(
            {negative: decodeFromFields("bool", fields.negative), magnitude: decodeFromFields("u64", fields.magnitude)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return I64.reified().new(
            {negative: decodeFromFieldsWithTypes("bool", item.fields.negative), magnitude: decodeFromFieldsWithTypes("u64", item.fields.magnitude)}
        )
    }
    ...
    static fromJSONField(
        ...
        return I64.reified().new(
            {negative: decodeFromJSONField("bool", field.negative), magnitude: decodeFromJSONField("u64", field.magnitude)}
        )
    }
