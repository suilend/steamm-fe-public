...
export interface PriceFeedFields {
    priceIdentifier: ToField<PriceIdentifier>; price: ToField<Price>; emaPrice: ToField<Price>
}

export type PriceFeedReified = Reified<
    PriceFeed,
    PriceFeedFields
>;
...
export class PriceFeed implements StructClass {
    ...
    static reified(): PriceFeedReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                PriceFeed.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PriceFeed.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                PriceFeed.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                PriceFeed.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => PriceFeed.fetch(
                client,
                id,
            ),
            new: (
                fields: PriceFeedFields,
            ) => {
    ...
    static fromFields(
        ...
        return PriceFeed.reified().new(
            {priceIdentifier: decodeFromFields(PriceIdentifier.reified(), fields.price_identifier), price: decodeFromFields(Price.reified(), fields.price), emaPrice: decodeFromFields(Price.reified(), fields.ema_price)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return PriceFeed.reified().new(
            {priceIdentifier: decodeFromFieldsWithTypes(PriceIdentifier.reified(), item.fields.price_identifier), price: decodeFromFieldsWithTypes(Price.reified(), item.fields.price), emaPrice: decodeFromFieldsWithTypes(Price.reified(), item.fields.ema_price)}
        )
    }
    ...
    static fromBcs(
        ...
        return PriceFeed.fromFields(
            PriceFeed.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return PriceFeed.reified().new(
            {priceIdentifier: decodeFromJSONField(PriceIdentifier.reified(), field.priceIdentifier), price: decodeFromJSONField(Price.reified(), field.price), emaPrice: decodeFromJSONField(Price.reified(), field.emaPrice)}
        )
    }
    ...
    static fromJSON(
        ...
        return PriceFeed.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PriceFeed.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PriceFeed.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PriceFeed.fromSuiObjectData(
            res.data
        );
    }
}
