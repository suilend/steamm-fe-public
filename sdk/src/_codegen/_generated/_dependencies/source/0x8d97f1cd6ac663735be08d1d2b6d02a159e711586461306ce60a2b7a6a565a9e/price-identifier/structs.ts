...
export class PriceIdentifier implements StructClass {
    ...
    static reified(): PriceIdentifierReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                PriceIdentifier.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PriceIdentifier.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                PriceIdentifier.fromBcs(
                    data,
                ),
            bcs: PriceIdentifier.bcs,
            fromJSONField: (field: any) =>
                PriceIdentifier.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PriceIdentifier.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PriceIdentifier.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                PriceIdentifier.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiClient, id: string) => PriceIdentifier.fetch(
                client,
                id,
            ),
            new: (
                fields: PriceIdentifierFields,
            ) => {
    ...
    static fromBcs(
        ...
        return PriceIdentifier.fromFields(
            PriceIdentifier.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return PriceIdentifier.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PriceIdentifier.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PriceIdentifier.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PriceIdentifier.fromSuiObjectData(
            res.data
        );
    }
}
