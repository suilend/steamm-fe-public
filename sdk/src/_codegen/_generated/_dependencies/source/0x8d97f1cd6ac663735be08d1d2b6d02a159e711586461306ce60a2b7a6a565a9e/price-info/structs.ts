...
export interface PriceInfoFields {
    attestationTime: ToField<"u64">; arrivalTime: ToField<"u64">; priceFeed: ToField<PriceFeed>
}

export type PriceInfoReified = Reified<
    PriceInfo,
    PriceInfoFields
>;
...
export class PriceInfo implements StructClass {
    ...
    static reified(): PriceInfoReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                PriceInfo.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PriceInfo.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                PriceInfo.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                PriceInfo.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiClient, id: string) => PriceInfo.fetch(
                client,
                id,
            ),
            new: (
                fields: PriceInfoFields,
            ) => {
    ...
    static fromFields(
        ...
        return PriceInfo.reified().new(
            {attestationTime: decodeFromFields("u64", fields.attestation_time), arrivalTime: decodeFromFields("u64", fields.arrival_time), priceFeed: decodeFromFields(PriceFeed.reified(), fields.price_feed)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return PriceInfo.reified().new(
            {attestationTime: decodeFromFieldsWithTypes("u64", item.fields.attestation_time), arrivalTime: decodeFromFieldsWithTypes("u64", item.fields.arrival_time), priceFeed: decodeFromFieldsWithTypes(PriceFeed.reified(), item.fields.price_feed)}
        )
    }
    ...
    static fromBcs(
        ...
        return PriceInfo.fromFields(
            PriceInfo.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return PriceInfo.reified().new(
            {attestationTime: decodeFromJSONField("u64", field.attestationTime), arrivalTime: decodeFromJSONField("u64", field.arrivalTime), priceFeed: decodeFromJSONField(PriceFeed.reified(), field.priceFeed)}
        )
    }
    ...
    static fromJSON(
        ...
        return PriceInfo.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PriceInfo.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PriceInfo.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PriceInfo.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface PriceInfoObjectFields {
    id: ToField<UID>; priceInfo: ToField<PriceInfo>
}
...
export class PriceInfoObject implements StructClass {
    ...
    static reified(): PriceInfoObjectReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                PriceInfoObject.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PriceInfoObject.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                PriceInfoObject.fromBcs(
                    data,
                ),
            bcs: PriceInfoObject.bcs,
            fromJSONField: (field: any) =>
                PriceInfoObject.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PriceInfoObject.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PriceInfoObject.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                PriceInfoObject.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiClient, id: string) => PriceInfoObject.fetch(
                client,
                id,
            ),
            new: (
                fields: PriceInfoObjectFields,
            ) => {
    ...
    static fromFields(
        ...
        return PriceInfoObject.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), priceInfo: decodeFromFields(PriceInfo.reified(), fields.price_info)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return PriceInfoObject.reified().new(
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), priceInfo: decodeFromFieldsWithTypes(PriceInfo.reified(), item.fields.price_info)}
        )
    }
    ...
    static fromBcs(
        ...
        return PriceInfoObject.fromFields(
            PriceInfoObject.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return PriceInfoObject.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), priceInfo: decodeFromJSONField(PriceInfo.reified(), field.priceInfo)}
        )
    }
    ...
    static fromJSON(
        ...
        return PriceInfoObject.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PriceInfoObject.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return PriceInfoObject.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PriceInfoObject.fromSuiObjectData(
            res.data
        );
    }
}
