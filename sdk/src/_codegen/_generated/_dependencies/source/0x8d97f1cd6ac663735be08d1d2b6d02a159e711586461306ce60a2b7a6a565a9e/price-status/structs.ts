...
export type PriceStatusReified = Reified<
    PriceStatus,
    PriceStatusFields
>;
...
export class PriceStatus implements StructClass {
    ...
    static reified(): PriceStatusReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                PriceStatus.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PriceStatus.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromJSONField: (field: any) =>
                PriceStatus.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PriceStatus.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PriceStatus.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                PriceStatus.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => PriceStatus.fetch(
                client,
                id,
            ),
            new: (
                fields: PriceStatusFields,
            ) => {
    ...
    static fromBcs(
        ...
        return PriceStatus.fromFields(
            PriceStatus.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return PriceStatus.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PriceStatus.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return PriceStatus.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return PriceStatus.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PriceStatus.fromSuiObjectData(
            res.data
        );
    }
}
