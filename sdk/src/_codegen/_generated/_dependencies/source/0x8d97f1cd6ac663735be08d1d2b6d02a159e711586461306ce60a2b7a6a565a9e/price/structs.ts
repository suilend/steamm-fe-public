...
export interface PriceFields {
    price: ToField<I64>; conf: ToField<"u64">; expo: ToField<I64>; timestamp: ToField<"u64">
}

export type PriceReified = Reified<
    Price,
    PriceFields
>;
...
export class Price implements StructClass {
    ...
    static reified(): PriceReified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Price.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Price.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Price.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromFields(
        ...
        return Price.reified().new(
            {price: decodeFromFields(I64.reified(), fields.price), conf: decodeFromFields("u64", fields.conf), expo: decodeFromFields(I64.reified(), fields.expo), timestamp: decodeFromFields("u64", fields.timestamp)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return Price.reified().new(
            {price: decodeFromFieldsWithTypes(I64.reified(), item.fields.price), conf: decodeFromFieldsWithTypes("u64", item.fields.conf), expo: decodeFromFieldsWithTypes(I64.reified(), item.fields.expo), timestamp: decodeFromFieldsWithTypes("u64", item.fields.timestamp)}
        )
    }
    ...
    static fromBcs(
        ...
        return Price.fromFields(
            Price.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return Price.reified().new(
            {price: decodeFromJSONField(I64.reified(), field.price), conf: decodeFromJSONField("u64", field.conf), expo: decodeFromJSONField(I64.reified(), field.expo), timestamp: decodeFromJSONField("u64", field.timestamp)}
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Price.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Price.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Price.fromSuiObjectData(
            res.data
        );
    }
}
