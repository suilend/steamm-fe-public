...
export class PythFeeRecipient implements StructClass {
    ...
    static reified(): PythFeeRecipientReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                PythFeeRecipient.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                PythFeeRecipient.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                PythFeeRecipient.fromBcs(
                    data,
                ),
            bcs: PythFeeRecipient.bcs,
            fromJSONField: (field: any) =>
                PythFeeRecipient.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                PythFeeRecipient.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                PythFeeRecipient.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                PythFeeRecipient.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => PythFeeRecipient.fetch(
                client,
                id,
            ),
            new: (
                fields: PythFeeRecipientFields,
            ) => {
                return new PythFeeRecipient(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return PythFeeRecipient.fromFields(
            PythFeeRecipient.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return PythFeeRecipient.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return PythFeeRecipient.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return PythFeeRecipient.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return PythFeeRecipient.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return PythFeeRecipient.fromSuiObjectData(
            res.data
        );
    }
}
