...
export interface GovernanceDataSourceFields {
    emitterChainId: ToField<"u64">; emitterAddress: ToField<ExternalAddress>; initialSequence: ToField<"u64">
}
...
export class GovernanceDataSource implements StructClass {
    ...
    readonly emitterChainId:
        ToField<"u64">
    ; readonly emitterAddress:
        ToField<ExternalAddress>
    ; readonly initialSequence:
        ToField<"u64">
    ...
    static reified(): GovernanceDataSourceReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                GovernanceDataSource.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                GovernanceDataSource.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                GovernanceDataSource.fromBcs(
                    data,
                ),
            bcs: GovernanceDataSource.bcs,
            fromJSONField: (field: any) =>
                GovernanceDataSource.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                GovernanceDataSource.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                GovernanceDataSource.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: GovernanceDataSourceFields,
            ) => {
    ...
    static fromFields(
        ...
        return GovernanceDataSource.reified().new(
            {emitterChainId: decodeFromFields("u64", fields.emitter_chain_id), emitterAddress: decodeFromFields(ExternalAddress.reified(), fields.emitter_address), initialSequence: decodeFromFields("u64", fields.initial_sequence)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return GovernanceDataSource.reified().new(
            {emitterChainId: decodeFromFieldsWithTypes("u64", item.fields.emitter_chain_id), emitterAddress: decodeFromFieldsWithTypes(ExternalAddress.reified(), item.fields.emitter_address), initialSequence: decodeFromFieldsWithTypes("u64", item.fields.initial_sequence)}
        )
    }
    ...
    static fromJSONField(
        ...
        return GovernanceDataSource.reified().new(
            {emitterChainId: decodeFromJSONField("u64", field.emitterChainId), emitterAddress: decodeFromJSONField(ExternalAddress.reified(), field.emitterAddress), initialSequence: decodeFromJSONField("u64", field.initialSequence)}
        )
    }
    ...
    static fromJSON(
        ...
        return GovernanceDataSource.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return GovernanceDataSource.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return GovernanceDataSource.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return GovernanceDataSource.fromSuiObjectData(
            res.data
        );
    }
}
