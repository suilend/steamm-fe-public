...
export class StalePriceThreshold implements StructClass {
    ...
    static reified(): StalePriceThresholdReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                StalePriceThreshold.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                StalePriceThreshold.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                StalePriceThreshold.fromBcs(
                    data,
                ),
            bcs: StalePriceThreshold.bcs,
            fromJSONField: (field: any) =>
                StalePriceThreshold.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                StalePriceThreshold.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                StalePriceThreshold.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: StalePriceThresholdFields,
            ) => {
                return new StalePriceThreshold(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return StalePriceThreshold.fromFields(
            StalePriceThreshold.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return StalePriceThreshold.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return StalePriceThreshold.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return StalePriceThreshold.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return StalePriceThreshold.fromSuiObjectData(
            res.data
        );
    }
}
