...
export interface UpdateFeeFields {
    mantissa: ToField<"u64">; exponent: ToField<"u64">
}

export type UpdateFeeReified = Reified<
    UpdateFee,
    UpdateFeeFields
>;
...
export class UpdateFee implements StructClass {
    ...
    static reified(): UpdateFeeReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                UpdateFee.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                UpdateFee.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                UpdateFee.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                UpdateFee.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => UpdateFee.fetch(
                client,
                id,
            ),
            new: (
                fields: UpdateFeeFields,
            ) => {
    ...
    static fromFields(
        ...
        return UpdateFee.reified().new(
            {mantissa: decodeFromFields("u64", fields.mantissa), exponent: decodeFromFields("u64", fields.exponent)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return UpdateFee.reified().new(
            {mantissa: decodeFromFieldsWithTypes("u64", item.fields.mantissa), exponent: decodeFromFieldsWithTypes("u64", item.fields.exponent)}
        )
    }
    ...
    static fromBcs(
        ...
        return UpdateFee.fromFields(
            UpdateFee.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return UpdateFee.reified().new(
            {mantissa: decodeFromJSONField("u64", field.mantissa), exponent: decodeFromJSONField("u64", field.exponent)}
        )
    }
    ...
    static fromJSON(
        ...
        return UpdateFee.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return UpdateFee.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return UpdateFee.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return UpdateFee.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return UpdateFee.fromSuiObjectData(
            res.data
        );
    }
}
