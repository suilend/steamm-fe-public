...
export interface StateFields {
    id: ToField<UID>; governanceDataSource: ToField<DataSource>; stalePriceThreshold: ToField<"u64">; baseUpdateFee: ToField<"u64">; feeRecipientAddress: ToField<"address">; lastExecutedGovernanceSequence: ToField<"u64">; consumedVaas: ToField<ConsumedVAAs>; upgradeCap: ToField<UpgradeCap>
}
...
export class State implements StructClass {
    ...
    ; readonly governanceDataSource:
        ToField<DataSource>
    ; readonly stalePriceThreshold:
        ToField<"u64">
    ; readonly baseUpdateFee:
        ToField<"u64">
    ; readonly feeRecipientAddress:
        ToField<"address">
    ; readonly lastExecutedGovernanceSequence:
        ToField<"u64">
    ...
    static fromJSONField(
        ...
        return State.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), governanceDataSource: decodeFromJSONField(DataSource.reified(), field.governanceDataSource), stalePriceThreshold: decodeFromJSONField("u64", field.stalePriceThreshold), baseUpdateFee: decodeFromJSONField("u64", field.baseUpdateFee), feeRecipientAddress: decodeFromJSONField("address", field.feeRecipientAddress), lastExecutedGovernanceSequence: decodeFromJSONField("u64", field.lastExecutedGovernanceSequence), consumedVaas: decodeFromJSONField(ConsumedVAAs.reified(), field.consumedVaas), upgradeCap: decodeFromJSONField(UpgradeCap.reified(), field.upgradeCap)}
        )
    }
...
export type CurrentDigestReified = Reified<
    CurrentDigest,
    CurrentDigestFields
>;
...
export class CurrentDigest implements StructClass {
    ...
    static reified(): CurrentDigestReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                CurrentDigest.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                CurrentDigest.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                CurrentDigest.fromBcs(
                    data,
                ),
            bcs: CurrentDigest.bcs,
            fromJSONField: (field: any) =>
                CurrentDigest.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                CurrentDigest.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                CurrentDigest.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: CurrentDigestFields,
            ) => {
                return new CurrentDigest(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return CurrentDigest.fromFields(
            CurrentDigest.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return CurrentDigest.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return CurrentDigest.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return CurrentDigest.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return CurrentDigest.fromSuiObjectData(
            res.data
        );
    }
}
