...
export type V__DUMMYReified = Reified<
    V__DUMMY,
    V__DUMMYFields
>;
...
export class V__DUMMY implements StructClass {
    ...
    static fromBcs(
        ...
        return V__DUMMY.fromFields(
            V__DUMMY.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return V__DUMMY.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return V__DUMMY.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return V__DUMMY.fromSuiObjectData(
            res.data
        );
    }
}
...
export type V__0_1_1Reified = Reified<
    V__0_1_1,
    V__0_1_1Fields
>;
...
export class V__0_1_1 implements StructClass {
    ...
    static reified(): V__0_1_1Reified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                V__0_1_1.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                V__0_1_1.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => V__0_1_1.fetch(
                client,
                id,
            ),
            new: (
                fields: V__0_1_1Fields,
            ) => {
                return new V__0_1_1(
                    [],
                    fields
    ...
    static fromBcs(
        ...
        return V__0_1_1.fromFields(
            V__0_1_1.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return V__0_1_1.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return V__0_1_1.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return V__0_1_1.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return V__0_1_1.fromSuiObjectData(
            res.data
        );
    }
}
...
export type V__0_1_2Reified = Reified<
    V__0_1_2,
    V__0_1_2Fields
>;
...
export class V__0_1_2 implements StructClass {
    ...
    static reified(): V__0_1_2Reified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                V__0_1_2.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                V__0_1_2.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => V__0_1_2.fetch(
                client,
                id,
            ),
            new: (
                fields: V__0_1_2Fields,
            ) => {
                return new V__0_1_2(
                    [],
                    fields
    ...
    static fromBcs(
        ...
        return V__0_1_2.fromFields(
            V__0_1_2.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return V__0_1_2.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return V__0_1_2.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return V__0_1_2.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return V__0_1_2.fromSuiObjectData(
            res.data
        );
    }
}
