...
export interface FeeConfigFields {
    suiMintFeeBps: ToField<"u64">; stakedSuiMintFeeBps: ToField<"u64">; redeemFeeBps: ToField<"u64">; stakedSuiRedeemFeeBps: ToField<"u64">; spreadFeeBps: ToField<"u64">; customRedeemFeeBps: ToField<"u64">; extraFields: ToField<Bag>
}
...
export class FeeConfig implements StructClass {
    ...
    readonly suiMintFeeBps:
        ToField<"u64">
    ; readonly stakedSuiMintFeeBps:
        ToField<"u64">
    ; readonly redeemFeeBps:
        ToField<"u64">
    ; readonly stakedSuiRedeemFeeBps:
        ToField<"u64">
    ; readonly spreadFeeBps:
        ToField<"u64">
    ; readonly customRedeemFeeBps:
        ToField<"u64">
    ...
    static fromFields(
        ...
        return FeeConfig.reified().new(
            {suiMintFeeBps: decodeFromFields("u64", fields.sui_mint_fee_bps), stakedSuiMintFeeBps: decodeFromFields("u64", fields.staked_sui_mint_fee_bps), redeemFeeBps: decodeFromFields("u64", fields.redeem_fee_bps), stakedSuiRedeemFeeBps: decodeFromFields("u64", fields.staked_sui_redeem_fee_bps), spreadFeeBps: decodeFromFields("u64", fields.spread_fee_bps), customRedeemFeeBps: decodeFromFields("u64", fields.custom_redeem_fee_bps), extraFields: decodeFromFields(Bag.reified(), fields.extra_fields)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return FeeConfig.reified().new(
            {suiMintFeeBps: decodeFromFieldsWithTypes("u64", item.fields.sui_mint_fee_bps), stakedSuiMintFeeBps: decodeFromFieldsWithTypes("u64", item.fields.staked_sui_mint_fee_bps), redeemFeeBps: decodeFromFieldsWithTypes("u64", item.fields.redeem_fee_bps), stakedSuiRedeemFeeBps: decodeFromFieldsWithTypes("u64", item.fields.staked_sui_redeem_fee_bps), spreadFeeBps: decodeFromFieldsWithTypes("u64", item.fields.spread_fee_bps), customRedeemFeeBps: decodeFromFieldsWithTypes("u64", item.fields.custom_redeem_fee_bps), extraFields: decodeFromFieldsWithTypes(Bag.reified(), item.fields.extra_fields)}
        )
    }
...
export class FeeConfigBuilder implements StructClass {
    ...
    static reified(): FeeConfigBuilderReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                FeeConfigBuilder.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                FeeConfigBuilder.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                FeeConfigBuilder.fromBcs(
                    data,
                ),
            bcs: FeeConfigBuilder.bcs,
            fromJSONField: (field: any) =>
                FeeConfigBuilder.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                FeeConfigBuilder.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                FeeConfigBuilder.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromBcs(
        ...
        return FeeConfigBuilder.fromFields(
            FeeConfigBuilder.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return FeeConfigBuilder.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return FeeConfigBuilder.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return FeeConfigBuilder.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return FeeConfigBuilder.fromSuiObjectData(
            res.data
        );
    }
}
