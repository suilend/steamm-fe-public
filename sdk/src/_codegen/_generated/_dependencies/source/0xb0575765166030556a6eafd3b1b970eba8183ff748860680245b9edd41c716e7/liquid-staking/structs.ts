...
export class AdminCap<P extends PhantomTypeArgument> implements StructClass {
    ...
    private constructor(typeArgs: [PhantomToTypeStr<P>], fields: AdminCapFields<P>,
    ) {
    ...
    static reified<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            new: (
                fields: AdminCapFields<ToPhantomTypeArgument<P>>,
            ) => {
                return new AdminCap(
                    [extractType(P)],
                    fields
    ...
    static fromJSON<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(AdminCap.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )
    ...
    static fromSuiObjectData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return AdminCap.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return AdminCap.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export interface CollectFeesEventFields {
    typename: ToField<TypeName>; amount: ToField<"u64">
}
...
export class CollectFeesEvent implements StructClass {
    ...
    static reified(): CollectFeesEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                CollectFeesEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                CollectFeesEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                CollectFeesEvent.fromBcs(
                    data,
                ),
            bcs: CollectFeesEvent.bcs,
            fromJSONField: (field: any) =>
                CollectFeesEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                CollectFeesEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                CollectFeesEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromFields(
        ...
        return CollectFeesEvent.reified().new(
            {typename: decodeFromFields(TypeName.reified(), fields.typename), amount: decodeFromFields("u64", fields.amount)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return CollectFeesEvent.reified().new(
            {typename: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.typename), amount: decodeFromFieldsWithTypes("u64", item.fields.amount)}
        )
    }
    ...
    static fromJSONField(
        ...
        return CollectFeesEvent.reified().new(
            {typename: decodeFromJSONField(TypeName.reified(), field.typename), amount: decodeFromJSONField("u64", field.amount)}
        )
    }
    ...
    static fromJSON(
        ...
        return CollectFeesEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return CollectFeesEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return CollectFeesEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return CollectFeesEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface CreateEventFields {
    typename: ToField<TypeName>; liquidStakingInfoId: ToField<ID>
}

export type CreateEventReified = Reified<
    CreateEvent,
    CreateEventFields
>;
...
export class CreateEvent implements StructClass {
    ...
    static reified(): CreateEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                CreateEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                CreateEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                CreateEvent.fromBcs(
    ...
    static fromFields(
        ...
        return CreateEvent.reified().new(
            {typename: decodeFromFields(TypeName.reified(), fields.typename), liquidStakingInfoId: decodeFromFields(ID.reified(), fields.liquid_staking_info_id)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return CreateEvent.reified().new(
            {typename: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.typename), liquidStakingInfoId: decodeFromFieldsWithTypes(ID.reified(), item.fields.liquid_staking_info_id)}
        )
    }
    ...
    static fromBcs(
        ...
        return CreateEvent.fromFields(
            CreateEvent.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return CreateEvent.reified().new(
            {typename: decodeFromJSONField(TypeName.reified(), field.typename), liquidStakingInfoId: decodeFromJSONField(ID.reified(), field.liquidStakingInfoId)}
        )
    }
    ...
    static fromJSON(
        ...
        return CreateEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return CreateEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return CreateEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return CreateEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface DecreaseValidatorStakeEventFields {
    typename: ToField<TypeName>; stakingPoolId: ToField<ID>; amount: ToField<"u64">
}
...
export class DecreaseValidatorStakeEvent implements StructClass {
    ...
    static reified(): DecreaseValidatorStakeEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                DecreaseValidatorStakeEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                DecreaseValidatorStakeEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                DecreaseValidatorStakeEvent.fromBcs(
                    data,
                ),
            bcs: DecreaseValidatorStakeEvent.bcs,
            fromJSONField: (field: any) =>
                DecreaseValidatorStakeEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                DecreaseValidatorStakeEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                DecreaseValidatorStakeEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: DecreaseValidatorStakeEventFields,
            ) => {
                return new DecreaseValidatorStakeEvent(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return DecreaseValidatorStakeEvent.reified().new(
            {typename: decodeFromFields(TypeName.reified(), fields.typename), stakingPoolId: decodeFromFields(ID.reified(), fields.staking_pool_id), amount: decodeFromFields("u64", fields.amount)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return DecreaseValidatorStakeEvent.reified().new(
            {typename: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.typename), stakingPoolId: decodeFromFieldsWithTypes(ID.reified(), item.fields.staking_pool_id), amount: decodeFromFieldsWithTypes("u64", item.fields.amount)}
        )
    }
    ...
    static fromJSONField(
        ...
        return DecreaseValidatorStakeEvent.reified().new(
            {typename: decodeFromJSONField(TypeName.reified(), field.typename), stakingPoolId: decodeFromJSONField(ID.reified(), field.stakingPoolId), amount: decodeFromJSONField("u64", field.amount)}
        )
    }
    ...
    static fromJSON(
        ...
        return DecreaseValidatorStakeEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isDecreaseValidatorStakeEvent(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a DecreaseValidatorStakeEvent object`);
        }
        return DecreaseValidatorStakeEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isDecreaseValidatorStakeEvent(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a DecreaseValidatorStakeEvent object`);
        }

        return DecreaseValidatorStakeEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface EpochChangedEventFields {
    typename: ToField<TypeName>; oldSuiSupply: ToField<"u64">; newSuiSupply: ToField<"u64">; lstSupply: ToField<"u64">; spreadFee: ToField<"u64">
}
...
export class EpochChangedEvent implements StructClass {
    ...
    readonly typename:
        ToField<TypeName>
    ; readonly oldSuiSupply:
        ToField<"u64">
    ; readonly newSuiSupply:
        ToField<"u64">
    ; readonly lstSupply:
        ToField<"u64">
    ; readonly spreadFee:
    ...
    static reified(): EpochChangedEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                EpochChangedEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                EpochChangedEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                EpochChangedEvent.fromBcs(
                    data,
                ),
            bcs: EpochChangedEvent.bcs,
            fromJSONField: (field: any) =>
                EpochChangedEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                EpochChangedEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                EpochChangedEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: EpochChangedEventFields,
            ) => {
                return new EpochChangedEvent(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return EpochChangedEvent.reified().new(
            {typename: decodeFromFields(TypeName.reified(), fields.typename), oldSuiSupply: decodeFromFields("u64", fields.old_sui_supply), newSuiSupply: decodeFromFields("u64", fields.new_sui_supply), lstSupply: decodeFromFields("u64", fields.lst_supply), spreadFee: decodeFromFields("u64", fields.spread_fee)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return EpochChangedEvent.reified().new(
            {typename: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.typename), oldSuiSupply: decodeFromFieldsWithTypes("u64", item.fields.old_sui_supply), newSuiSupply: decodeFromFieldsWithTypes("u64", item.fields.new_sui_supply), lstSupply: decodeFromFieldsWithTypes("u64", item.fields.lst_supply), spreadFee: decodeFromFieldsWithTypes("u64", item.fields.spread_fee)}
        )
    }
    ...
    static fromJSONField(
        ...
        return EpochChangedEvent.reified().new(
            {typename: decodeFromJSONField(TypeName.reified(), field.typename), oldSuiSupply: decodeFromJSONField("u64", field.oldSuiSupply), newSuiSupply: decodeFromJSONField("u64", field.newSuiSupply), lstSupply: decodeFromJSONField("u64", field.lstSupply), spreadFee: decodeFromJSONField("u64", field.spreadFee)}
        )
    }
    ...
    static fromJSON(
        ...
        return EpochChangedEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return EpochChangedEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return EpochChangedEvent.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return EpochChangedEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export class IncreaseValidatorStakeEvent implements StructClass {
    ...
    static reified(): IncreaseValidatorStakeEventReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                IncreaseValidatorStakeEvent.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                IncreaseValidatorStakeEvent.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                IncreaseValidatorStakeEvent.fromBcs(
                    data,
                ),
            bcs: IncreaseValidatorStakeEvent.bcs,
            fromJSONField: (field: any) =>
                IncreaseValidatorStakeEvent.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                IncreaseValidatorStakeEvent.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                IncreaseValidatorStakeEvent.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: IncreaseValidatorStakeEventFields,
            ) => {
                return new IncreaseValidatorStakeEvent(
                    [],
                    fields
                )
            },
    ...
    static fromJSON(
        ...
        return IncreaseValidatorStakeEvent.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isIncreaseValidatorStakeEvent(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a IncreaseValidatorStakeEvent object`);
        }
        return IncreaseValidatorStakeEvent.fromFieldsWithTypes(
            content
        );
    }
    ...
    static async fetch(
        ...
        if (res.data?.bcs?.dataType !== "moveObject" || !isIncreaseValidatorStakeEvent(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a IncreaseValidatorStakeEvent object`);
        }

        return IncreaseValidatorStakeEvent.fromSuiObjectData(
            res.data
        );
    }
}
...
export class LIQUID_STAKING implements StructClass {
    ...
    static reified(): LIQUID_STAKINGReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                LIQUID_STAKING.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                LIQUID_STAKING.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                LIQUID_STAKING.fromBcs(
                    data,
                ),
            bcs: LIQUID_STAKING.bcs,
            fromJSONField: (field: any) =>
                LIQUID_STAKING.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                LIQUID_STAKING.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                LIQUID_STAKING.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
    ...
    static fromBcs(
        ...
        return LIQUID_STAKING.fromFields(
            LIQUID_STAKING.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return LIQUID_STAKING.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return LIQUID_STAKING.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return LIQUID_STAKING.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return LIQUID_STAKING.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface LiquidStakingInfoFields<P extends PhantomTypeArgument> {
    id: ToField<UID>; lstTreasuryCap: ToField<TreasuryCap<P>>; feeConfig: ToField<Cell<FeeConfig>>; fees: ToField<Balance<ToPhantom<SUI>>>; accruedSpreadFees: ToField<"u64">; storage: ToField<Storage>; version: ToField<Version>; extraFields: ToField<Bag>
}
...
export class LiquidStakingInfo<P extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    readonly id:
        ToField<UID>
    ; readonly lstTreasuryCap:
        ToField<TreasuryCap<P>>
    ; readonly feeConfig:
        ToField<Cell<FeeConfig>>
    ; readonly fees:
        ToField<Balance<ToPhantom<SUI>>>
    ; readonly accruedSpreadFees:
        ToField<"u64">
    ; readonly storage:
        ToField<Storage>
    ; readonly version:
    ...
    private constructor(typeArgs: [PhantomToTypeStr<P>], fields: LiquidStakingInfoFields<P>,
    ) {
        this.$fullTypeName = composeSuiType(
    ...
    static reified<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            reifiedTypeArgs: [P],
            fromFields: (fields: Record<string, any>) =>
                LiquidStakingInfo.fromFields(
                    P,
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                LiquidStakingInfo.fromFieldsWithTypes(
                    P,
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                LiquidStakingInfo.fromBcs(
                    P,
                    data,
                ),
            bcs: LiquidStakingInfo.bcs,
            fromJSONField: (field: any) =>
                LiquidStakingInfo.fromJSONField(
                    P,
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                LiquidStakingInfo.fromJSON(
                    P,
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                LiquidStakingInfo.fromSuiParsedData(
                    P,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                LiquidStakingInfo.fromSuiObjectData(
                    P,
                    content,
                ),
            ...
            new: (
                fields: LiquidStakingInfoFields<ToPhantomTypeArgument<P>>,
            ) => {
    ...
    static phantom<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return phantom(LiquidStakingInfo.reified(
            P
        ));
    }
    ...
    static fromFieldsWithTypes<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return LiquidStakingInfo.reified(
            ...
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), lstTreasuryCap: decodeFromFieldsWithTypes(TreasuryCap.reified(typeArg), item.fields.lst_treasury_cap), feeConfig: decodeFromFieldsWithTypes(Cell.reified(FeeConfig.reified()), item.fields.fee_config), fees: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(SUI.reified())), item.fields.fees), accruedSpreadFees: decodeFromFieldsWithTypes("u64", item.fields.accrued_spread_fees), storage: decodeFromFieldsWithTypes(Storage.reified(), item.fields.storage), version: decodeFromFieldsWithTypes(Version.reified(), item.fields.version), extraFields: decodeFromFieldsWithTypes(Bag.reified(), item.fields.extra_fields)}
        )
    }
    ...
    static fromJSONField<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return LiquidStakingInfo.reified(
            ...
            {id: decodeFromJSONField(UID.reified(), field.id), lstTreasuryCap: decodeFromJSONField(TreasuryCap.reified(typeArg), field.lstTreasuryCap), feeConfig: decodeFromJSONField(Cell.reified(FeeConfig.reified()), field.feeConfig), fees: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.fees), accruedSpreadFees: decodeFromJSONField("u64", field.accruedSpreadFees), storage: decodeFromJSONField(Storage.reified(), field.storage), version: decodeFromJSONField(Version.reified(), field.version), extraFields: decodeFromJSONField(Bag.reified(), field.extraFields)}
        )
    }
    ...
    static fromJSON<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(LiquidStakingInfo.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return LiquidStakingInfo.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return LiquidStakingInfo.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return LiquidStakingInfo.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return LiquidStakingInfo.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export interface MintEventFields {
    typename: ToField<TypeName>; suiAmountIn: ToField<"u64">; lstAmountOut: ToField<"u64">; feeAmount: ToField<"u64">
}
...
export class MintEvent implements StructClass {
    ...
    readonly typename:
        ToField<TypeName>
    ; readonly suiAmountIn:
        ToField<"u64">
    ; readonly lstAmountOut:
        ToField<"u64">
    ; readonly feeAmount:
        ToField<"u64">
    ...
    static fromFields(
        ...
        return MintEvent.reified().new(
            {typename: decodeFromFields(TypeName.reified(), fields.typename), suiAmountIn: decodeFromFields("u64", fields.sui_amount_in), lstAmountOut: decodeFromFields("u64", fields.lst_amount_out), feeAmount: decodeFromFields("u64", fields.fee_amount)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return MintEvent.reified().new(
            {typename: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.typename), suiAmountIn: decodeFromFieldsWithTypes("u64", item.fields.sui_amount_in), lstAmountOut: decodeFromFieldsWithTypes("u64", item.fields.lst_amount_out), feeAmount: decodeFromFieldsWithTypes("u64", item.fields.fee_amount)}
        )
    }
    ...
    static fromJSONField(
        ...
        return MintEvent.reified().new(
            {typename: decodeFromJSONField(TypeName.reified(), field.typename), suiAmountIn: decodeFromJSONField("u64", field.suiAmountIn), lstAmountOut: decodeFromJSONField("u64", field.lstAmountOut), feeAmount: decodeFromJSONField("u64", field.feeAmount)}
        )
    }
...
export interface RedeemEventFields {
    typename: ToField<TypeName>; lstAmountIn: ToField<"u64">; suiAmountOut: ToField<"u64">; feeAmount: ToField<"u64">
}
...
export class RedeemEvent implements StructClass {
    ...
    readonly typename:
        ToField<TypeName>
    ; readonly lstAmountIn:
        ToField<"u64">
    ; readonly suiAmountOut:
        ToField<"u64">
    ; readonly feeAmount:
        ToField<"u64">
    ...
    static fromFields(
        ...
        return RedeemEvent.reified().new(
            {typename: decodeFromFields(TypeName.reified(), fields.typename), lstAmountIn: decodeFromFields("u64", fields.lst_amount_in), suiAmountOut: decodeFromFields("u64", fields.sui_amount_out), feeAmount: decodeFromFields("u64", fields.fee_amount)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return RedeemEvent.reified().new(
            {typename: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.typename), lstAmountIn: decodeFromFieldsWithTypes("u64", item.fields.lst_amount_in), suiAmountOut: decodeFromFieldsWithTypes("u64", item.fields.sui_amount_out), feeAmount: decodeFromFieldsWithTypes("u64", item.fields.fee_amount)}
        )
    }
    ...
    static fromJSONField(
        ...
        return RedeemEvent.reified().new(
            {typename: decodeFromJSONField(TypeName.reified(), field.typename), lstAmountIn: decodeFromJSONField("u64", field.lstAmountIn), suiAmountOut: decodeFromJSONField("u64", field.suiAmountOut), feeAmount: decodeFromJSONField("u64", field.feeAmount)}
        )
    }
