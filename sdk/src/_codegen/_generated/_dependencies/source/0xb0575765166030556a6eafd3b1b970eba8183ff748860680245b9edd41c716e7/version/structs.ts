...
export type VersionReified = Reified<
    Version,
    VersionFields
>;
...
export class Version implements StructClass {
    ...
    static reified(): VersionReified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Version.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Version.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Version.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromBcs(
        ...
        return Version.fromFields(
            Version.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Version.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Version.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Version.fromSuiObjectData(
            res.data
        );
    }
}
