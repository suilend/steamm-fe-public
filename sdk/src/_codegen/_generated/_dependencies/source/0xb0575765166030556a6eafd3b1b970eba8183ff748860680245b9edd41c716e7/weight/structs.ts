...
export type WEIGHTReified = Reified<
    WEIGHT,
    WEIGHTFields
>;
...
export class WEIGHT implements StructClass {
    ...
    static fromBcs(
        ...
        return WEIGHT.fromFields(
            WEIGHT.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return WEIGHT.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return WEIGHT.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return WEIGHT.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface WeightHookFields<P extends PhantomTypeArgument> {
    id: ToField<UID>; validatorAddressesAndWeights: ToField<VecMap<"address", "u64">>; totalWeight: ToField<"u64">; adminCap: ToField<AdminCap<P>>; version: ToField<Version>; extraFields: ToField<Bag>
}
...
export class WeightHook<P extends PhantomTypeArgument> implements StructClass {
    ...
    readonly id:
        ToField<UID>
    ; readonly validatorAddressesAndWeights:
    ...
    private constructor(typeArgs: [PhantomToTypeStr<P>], fields: WeightHookFields<P>,
    ) {
        this.$fullTypeName = composeSuiType(
            WeightHook.$typeName,
            ...typeArgs
    ...
    static reified<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            reifiedTypeArgs: [P],
            fromFields: (fields: Record<string, any>) =>
                WeightHook.fromFields(
                    P,
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                WeightHook.fromFieldsWithTypes(
                    P,
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                WeightHook.fromSuiParsedData(
                    P,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                WeightHook.fromSuiObjectData(
                    P,
                    content,
                ),
            ...
            new: (
                fields: WeightHookFields<ToPhantomTypeArgument<P>>,
            ) => {
    ...
    static phantom<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return phantom(WeightHook.reified(
            P
        ));
    }
    ...
    static fromBcs<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WeightHook.fromFields(
            typeArg,
            WeightHook.bcs.parse(data)
        )
    }
    ...
    static fromJSONField<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WeightHook.reified(
            ...
            {id: decodeFromJSONField(UID.reified(), field.id), validatorAddressesAndWeights: decodeFromJSONField(VecMap.reified("address", "u64"), field.validatorAddressesAndWeights), totalWeight: decodeFromJSONField("u64", field.totalWeight), adminCap: decodeFromJSONField(AdminCap.reified(typeArg), field.adminCap), version: decodeFromJSONField(Version.reified(), field.version), extraFields: decodeFromJSONField(Bag.reified(), field.extraFields)}
        )
    }
    ...
    static fromJSON<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(WeightHook.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return WeightHook.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WeightHook.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return WeightHook.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WeightHook.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
...
export class WeightHookAdminCap<P extends PhantomTypeArgument> implements StructClass {
    __StructClass = true as const;
    ...
    private constructor(typeArgs: [PhantomToTypeStr<P>], fields: WeightHookAdminCapFields<P>,
    ) {
        this.$fullTypeName = composeSuiType(
    ...
    static reified<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            reifiedTypeArgs: [P],
            fromFields: (fields: Record<string, any>) =>
                WeightHookAdminCap.fromFields(
                    P,
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                WeightHookAdminCap.fromFieldsWithTypes(
                    P,
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                WeightHookAdminCap.fromBcs(
                    P,
                    data,
                ),
            bcs: WeightHookAdminCap.bcs,
            fromJSONField: (field: any) =>
                WeightHookAdminCap.fromJSONField(
                    P,
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                WeightHookAdminCap.fromJSON(
                    P,
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                WeightHookAdminCap.fromSuiParsedData(
                    P,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                WeightHookAdminCap.fromSuiObjectData(
                    P,
                    content,
                ),
            ...
            new: (
                fields: WeightHookAdminCapFields<ToPhantomTypeArgument<P>>,
            ) => {
    ...
    static phantom<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return phantom(WeightHookAdminCap.reified(
            P
        ));
    }
    ...
    static fromJSON<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(WeightHookAdminCap.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return WeightHookAdminCap.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WeightHookAdminCap.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return WeightHookAdminCap.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return WeightHookAdminCap.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
