...
export class Cell<Element extends TypeArgument> implements StructClass {
    ...
    readonly element:
        ToField<Option<Element>>

    private constructor(typeArgs: [ToTypeStr<Element>], fields: CellFields<Element>,
    ) {
    ...
    static reified<Element extends Reified<TypeArgument, any>>(
        ...
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Cell.fromSuiParsedData(
                    Element,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Cell.fromSuiObjectData(
                    Element,
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => Cell.fetch(
                client,
                Element,
                id,
            ),
            new: (
                fields: CellFields<ToTypeArgument<Element>>,
            ) => {
                return new Cell(
                    [extractType(Element)],
                    fields
    ...
    static get bcs() {
        return <Element extends BcsType<any>>(Element: Element) => bcs.struct(`Cell<${Element.name}>`, {
            element:
                Option.bcs(Element)
    ...
    static fromBcs<Element extends Reified<TypeArgument, any>>(
        ...
        return Cell.fromFields(
            typeArg,
            Cell.bcs(toBcs(typeArgs[0])).parse(data)
        )
    }
    ...
    static fromJSON<Element extends Reified<TypeArgument, any>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(Cell.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return Cell.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<Element extends Reified<TypeArgument, any>>(
        ...
        return Cell.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<Element extends Reified<TypeArgument, any>>(
        typeArg: Element, data: SuiObjectData
    ): Cell<ToTypeArgument<Element>> {
        if (data.bcs) {
