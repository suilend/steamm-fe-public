...
export type DecimalReified = Reified<
    Decimal,
    DecimalFields
>;
...
export class Decimal implements StructClass {
    ...
    static fromBcs(
        ...
        return Decimal.fromFields(
            Decimal.bcs.parse(data)
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return Decimal.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return Decimal.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return Decimal.fromSuiObjectData(
            res.data
        );
    }
}
