...
export interface RegistryFields {
    id: ToField<UID>; version: ToField<"u64">; lendingMarkets: ToField<Table<ToPhantom<TypeName>, ToPhantom<ID>>>
}
...
export class Registry implements StructClass {
    ...
    static fromFields(
        ...
        return Registry.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), version: decodeFromFields("u64", fields.version), lendingMarkets: decodeFromFields(Table.reified(reified.phantom(TypeName.reified()), reified.phantom(ID.reified())), fields.lending_markets)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return Registry.reified().new(
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), version: decodeFromFieldsWithTypes("u64", item.fields.version), lendingMarkets: decodeFromFieldsWithTypes(Table.reified(reified.phantom(TypeName.reified()), reified.phantom(ID.reified())), item.fields.lending_markets)}
        )
    }
    ...
    static fromJSONField(
        ...
        return Registry.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), version: decodeFromJSONField("u64", field.version), lendingMarkets: decodeFromJSONField(Table.reified(reified.phantom(TypeName.reified()), reified.phantom(ID.reified())), field.lendingMarkets)}
        )
    }
...
export class LENDING_MARKET_2 implements StructClass {
    ...
    static reified(): LENDING_MARKET_2Reified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                LENDING_MARKET_2.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                LENDING_MARKET_2.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                LENDING_MARKET_2.fromBcs(
                    data,
                ),
            bcs: LENDING_MARKET_2.bcs,
            fromJSONField: (field: any) =>
                LENDING_MARKET_2.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                LENDING_MARKET_2.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                LENDING_MARKET_2.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: LENDING_MARKET_2Fields,
            ) => {
                return new LENDING_MARKET_2(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return LENDING_MARKET_2.fromFields(
            LENDING_MARKET_2.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return LENDING_MARKET_2.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return LENDING_MARKET_2.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return LENDING_MARKET_2.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return LENDING_MARKET_2.fromSuiObjectData(
            res.data
        );
    }
}
