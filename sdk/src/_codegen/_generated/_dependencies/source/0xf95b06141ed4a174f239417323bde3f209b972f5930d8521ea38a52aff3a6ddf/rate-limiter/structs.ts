...
export interface RateLimiterFields {
    config: ToField<RateLimiterConfig>; prevQty: ToField<Decimal>; windowStart: ToField<"u64">; curQty: ToField<Decimal>
}

export type RateLimiterReified = Reified<
    RateLimiter,
    RateLimiterFields
>;
...
export class RateLimiter implements StructClass {
    ...
    static reified(): RateLimiterReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                RateLimiter.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                RateLimiter.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromJSONField: (field: any) =>
                RateLimiter.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                RateLimiter.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                RateLimiter.fromSuiParsedData(
                    content,
                ),
    ...
    static fromFields(
        ...
        return RateLimiter.reified().new(
            {config: decodeFromFields(RateLimiterConfig.reified(), fields.config), prevQty: decodeFromFields(Decimal.reified(), fields.prev_qty), windowStart: decodeFromFields("u64", fields.window_start), curQty: decodeFromFields(Decimal.reified(), fields.cur_qty)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return RateLimiter.reified().new(
            {config: decodeFromFieldsWithTypes(RateLimiterConfig.reified(), item.fields.config), prevQty: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.prev_qty), windowStart: decodeFromFieldsWithTypes("u64", item.fields.window_start), curQty: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.cur_qty)}
        )
    }
    ...
    static fromBcs(
        ...
        return RateLimiter.fromFields(
            RateLimiter.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return RateLimiter.reified().new(
            {config: decodeFromJSONField(RateLimiterConfig.reified(), field.config), prevQty: decodeFromJSONField(Decimal.reified(), field.prevQty), windowStart: decodeFromJSONField("u64", field.windowStart), curQty: decodeFromJSONField(Decimal.reified(), field.curQty)}
        )
    }
    ...
    static fromJSON(
        ...
        return RateLimiter.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return RateLimiter.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return RateLimiter.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return RateLimiter.fromSuiObjectData(
            res.data
        );
    }
}
...
export interface RateLimiterConfigFields {
    windowDuration: ToField<"u64">; maxOutflow: ToField<"u64">
}
...
export class RateLimiterConfig implements StructClass {
    ...
    static reified(): RateLimiterConfigReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                RateLimiterConfig.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                RateLimiterConfig.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                RateLimiterConfig.fromBcs(
                    data,
                ),
            bcs: RateLimiterConfig.bcs,
            fromJSONField: (field: any) =>
                RateLimiterConfig.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                RateLimiterConfig.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                RateLimiterConfig.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
            ...
            new: (
                fields: RateLimiterConfigFields,
            ) => {
    ...
    static fromFields(
        ...
        return RateLimiterConfig.reified().new(
            {windowDuration: decodeFromFields("u64", fields.window_duration), maxOutflow: decodeFromFields("u64", fields.max_outflow)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return RateLimiterConfig.reified().new(
            {windowDuration: decodeFromFieldsWithTypes("u64", item.fields.window_duration), maxOutflow: decodeFromFieldsWithTypes("u64", item.fields.max_outflow)}
        )
    }
    ...
    static fromBcs(
        ...
        return RateLimiterConfig.fromFields(
            RateLimiterConfig.bcs.parse(data)
        )
    }
    ...
    static fromJSONField(
        ...
        return RateLimiterConfig.reified().new(
            {windowDuration: decodeFromJSONField("u64", field.windowDuration), maxOutflow: decodeFromJSONField("u64", field.maxOutflow)}
        )
    }
    ...
    static fromJSON(
        ...
        return RateLimiterConfig.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return RateLimiterConfig.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.content) {
            return RateLimiterConfig.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return RateLimiterConfig.fromSuiObjectData(
            res.data
        );
    }
}
