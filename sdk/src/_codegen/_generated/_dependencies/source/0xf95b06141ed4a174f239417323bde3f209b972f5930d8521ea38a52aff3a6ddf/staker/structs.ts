...
export interface StakerFields<P extends PhantomTypeArgument> {
    admin: ToField<AdminCap<P>>; liquidStakingInfo: ToField<LiquidStakingInfo<P>>; lstBalance: ToField<Balance<P>>; suiBalance: ToField<Balance<ToPhantom<SUI>>>; liabilities: ToField<"u64">
}
...
export class Staker<P extends PhantomTypeArgument> implements StructClass {
    ...
    readonly admin:
        ToField<AdminCap<P>>
    ; readonly liquidStakingInfo:
        ToField<LiquidStakingInfo<P>>
    ; readonly lstBalance:
        ToField<Balance<P>>
    ; readonly suiBalance:
    ...
    private constructor(typeArgs: [PhantomToTypeStr<P>], fields: StakerFields<P>,
    ) {
    ...
    static reified<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                Staker.fromSuiParsedData(
                    P,
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                Staker.fromSuiObjectData(
                    P,
                    content,
                ),
            ...
            new: (
                fields: StakerFields<ToPhantomTypeArgument<P>>,
            ) => {
                return new Staker(
                    [extractType(P)],
                    fields
    ...
    static fromFields<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Staker.reified(
            ...
            {admin: decodeFromFields(AdminCap.reified(typeArg), fields.admin), liquidStakingInfo: decodeFromFields(LiquidStakingInfo.reified(typeArg), fields.liquid_staking_info), lstBalance: decodeFromFields(Balance.reified(typeArg), fields.lst_balance), suiBalance: decodeFromFields(Balance.reified(reified.phantom(SUI.reified())), fields.sui_balance), liabilities: decodeFromFields("u64", fields.liabilities)}
        )
    }
    ...
    static fromBcs<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Staker.fromFields(
            typeArg,
            Staker.bcs.parse(data)
        )
    }
    ...
    static fromJSONField<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Staker.reified(
            ...
            {admin: decodeFromJSONField(AdminCap.reified(typeArg), field.admin), liquidStakingInfo: decodeFromJSONField(LiquidStakingInfo.reified(typeArg), field.liquidStakingInfo), lstBalance: decodeFromJSONField(Balance.reified(typeArg), field.lstBalance), suiBalance: decodeFromJSONField(Balance.reified(reified.phantom(SUI.reified())), field.suiBalance), liabilities: decodeFromJSONField("u64", field.liabilities)}
        )
    }
    ...
    static fromJSON<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        assertReifiedTypeArgsMatch(
            composeSuiType(Staker.$typeName,
            extractType(typeArg)),
            json.$typeArgs,
            [typeArg],
        )

        return Staker.fromJSONField(
            typeArg,
            json,
        )
    }
    ...
    static fromSuiParsedData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Staker.fromFieldsWithTypes(
            typeArg,
            content
        );
    }
    ...
    static fromSuiObjectData<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        if (data.content) {
            return Staker.fromSuiParsedData(
                typeArg,
                data.content
            )
        }
    ...
    static async fetch<P extends PhantomReified<PhantomTypeArgument>>(
        ...
        return Staker.fromSuiObjectData(
            typeArg,
            res.data
        );
    }
