...
export type MAIN_POOLReified = Reified<
    MAIN_POOL,
    MAIN_POOLFields
>;
...
export class MAIN_POOL implements StructClass {
    ...
    static reified(): MAIN_POOLReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                MAIN_POOL.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                MAIN_POOL.fromFieldsWithTypes(
                    item,
                ),
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                MAIN_POOL.fromSuiParsedData(
                    content,
                ),
            fromSuiObjectData: (content: SuiObjectData) =>
                MAIN_POOL.fromSuiObjectData(
                    content,
                ),
            fetch: async (client: SuiJsonRpcClient, id: string) => MAIN_POOL.fetch(
                client,
                id,
            ),
            new: (
                fields: MAIN_POOLFields,
            ) => {
                return new MAIN_POOL(
                    [],
                    fields
                )
            },
    ...
    static fromBcs(
        ...
        return MAIN_POOL.fromFields(
            MAIN_POOL.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return MAIN_POOL.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return MAIN_POOL.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            ...
            return MAIN_POOL.fromBcs(
                fromBase64(data.bcs.bcsBytes)
            );
        }
        if (data.content) {
            return MAIN_POOL.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        return MAIN_POOL.fromSuiObjectData(
            res.data
        );
    }
}
