...
export interface MultiRouteSwapQuoteFields {
    amountIn: ToField<"u64">; amountOut: ToField<"u64">
}
...
export class MultiRouteSwapQuote implements StructClass {
    ...
    static reified(): MultiRouteSwapQuoteReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                MultiRouteSwapQuote.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                MultiRouteSwapQuote.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                MultiRouteSwapQuote.fromBcs(
                    data,
                ),
            bcs: MultiRouteSwapQuote.bcs,
            fromJSONField: (field: any) =>
                MultiRouteSwapQuote.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                MultiRouteSwapQuote.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                MultiRouteSwapQuote.fromSuiParsedData(
                    content,
                ),
            ...
            new: (
                fields: MultiRouteSwapQuoteFields,
            ) => {
                return new MultiRouteSwapQuote(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return MultiRouteSwapQuote.reified().new(
            {amountIn: decodeFromFields("u64", fields.amount_in), amountOut: decodeFromFields("u64", fields.amount_out)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return MultiRouteSwapQuote.reified().new(
            {amountIn: decodeFromFieldsWithTypes("u64", item.fields.amount_in), amountOut: decodeFromFieldsWithTypes("u64", item.fields.amount_out)}
        )
    }
    ...
    static fromBcs(
        ...
        return MultiRouteSwapQuote.fromFields(
            MultiRouteSwapQuote.bcs.parse(data)
        )
    }

    toJSONField() {
        return {
            amountIn: this.amountIn.toString(),amountOut: this.amountOut.toString(),
    ...
    static fromJSONField(
        ...
        return MultiRouteSwapQuote.reified().new(
            {amountIn: decodeFromJSONField("u64", field.amountIn), amountOut: decodeFromJSONField("u64", field.amountOut)}
        )
    }
    ...
    static fromJSON(
        ...
        return MultiRouteSwapQuote.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        if (!isMultiRouteSwapQuote(content.type)) {
            throw new Error(`object at ${(content.fields as any).id} is not a MultiRouteSwapQuote object`);
        }
        return MultiRouteSwapQuote.fromFieldsWithTypes(
            content
        );
    }
    ...
    static fromSuiObjectData(
        ...
        if (data.bcs) {
            if (data.bcs.dataType !== "moveObject" || !isMultiRouteSwapQuote(data.bcs.type)) {
        ...
        if (data.content) {
            return MultiRouteSwapQuote.fromSuiParsedData(
                data.content
            )
        }
    ...
    static async fetch(
        ...
        if (res.error) {
            throw new Error(`error fetching MultiRouteSwapQuote object at id ${id}: ${res.error.code}`);
        }
        if (res.data?.bcs?.dataType !== "moveObject" || !isMultiRouteSwapQuote(res.data.bcs.type)) {
            throw new Error(`object at id ${id} is not a MultiRouteSwapQuote object`);
        }

        return MultiRouteSwapQuote.fromSuiObjectData(
            res.data
        );
    }
}
