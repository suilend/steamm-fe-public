...
export interface NewArgs {
    registry: TransactionObjectInput; swapFeeBps: bigint | TransactionArgument; quoter: GenericArg; metaA: TransactionObjectInput; metaB: TransactionObjectInput; metaLp: TransactionObjectInput; lpTreasury: TransactionObjectInput
}
...
export function new_(
    ...
    return tx.moveCall({
        ...
        arguments: [
            obj(tx, args.registry), pure(tx, args.swapFeeBps, `u64`), generic(tx, `${typeArgs[2]}`, args.quoter), obj(tx, args.metaA), obj(tx, args.metaB), obj(tx, args.metaLp), obj(tx, args.lpTreasury)
        ],
    })
}

export interface SwapArgs {
    pool: TransactionObjectInput; coinA: TransactionObjectInput; coinB: TransactionObjectInput; quote: TransactionObjectInput; minAmountOut: bigint | TransactionArgument
}
...
export function swap(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), obj(tx, args.coinA), obj(tx, args.coinB), obj(tx, args.quote), pure(tx, args.minAmountOut, `u64`)
        ],
    })
}

export interface MigrateArgs {
    pool: TransactionObjectInput; admin: TransactionObjectInput
}
...
export function migrate(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), obj(tx, args.admin)
        ],
    })
}
...
export interface AssertLpSupplyReserveRatioArgs {
    initialReserveA: bigint | TransactionArgument; initialLpSupply: bigint | TransactionArgument; finalReserveA: bigint | TransactionArgument; finalLpSupply: bigint | TransactionArgument
}
...
export function assertLpSupplyReserveRatio(
    ...
    return tx.moveCall({
        ...
        arguments: [
            pure(tx, args.initialReserveA, `u64`), pure(tx, args.initialLpSupply, `u64`), pure(tx, args.finalReserveA, `u64`), pure(tx, args.finalLpSupply, `u64`)
        ],
    })
}

export interface QuoteDepositArgs {
    pool: TransactionObjectInput; maxA: bigint | TransactionArgument; maxB: bigint | TransactionArgument
}
...
export function quoteDeposit(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), pure(tx, args.maxA, `u64`), pure(tx, args.maxB, `u64`)
        ],
    })
}

export interface QuoteRedeemArgs {
    pool: TransactionObjectInput; lpTokens: bigint | TransactionArgument
}
...
export function quoteRedeem(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), pure(tx, args.lpTokens, `u64`)
        ],
    })
}

export interface AssertLiquidityArgs {
    reserveOut: bigint | TransactionArgument; amountOut: bigint | TransactionArgument
}
...
export function assertLiquidity(
    ...
    return tx.moveCall({
        ...
        arguments: [
            pure(tx, args.reserveOut, `u64`), pure(tx, args.amountOut, `u64`)
        ],
    })
}
...
export interface CollectProtocolFeesArgs {
    pool: TransactionObjectInput; globalAdmin: TransactionObjectInput
}
...
export function collectProtocolFees(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), obj(tx, args.globalAdmin)
        ],
    })
}

export interface ComputeSwapFees_Args {
    pool: TransactionObjectInput; amount: bigint | TransactionArgument
}
...
export function computeSwapFees_(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), pure(tx, args.amount, `u64`)
        ],
    })
}

export interface DepositLiquidityArgs {
    pool: TransactionObjectInput; coinA: TransactionObjectInput; coinB: TransactionObjectInput; maxA: bigint | TransactionArgument; maxB: bigint | TransactionArgument
}
...
export function depositLiquidity(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), obj(tx, args.coinA), obj(tx, args.coinB), pure(tx, args.maxA, `u64`), pure(tx, args.maxB, `u64`)
        ],
    })
}
...
export interface GetQuoteArgs {
    pool: TransactionObjectInput; amountIn: bigint | TransactionArgument; amountOut: bigint | TransactionArgument; a2B: boolean | TransactionArgument
}
...
export function getQuote(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), pure(tx, args.amountIn, `u64`), pure(tx, args.amountOut, `u64`), pure(tx, args.a2B, `bool`)
        ],
    })
}
...
export interface QuoteRedeem_Args {
    pool: TransactionObjectInput; lpTokens: bigint | TransactionArgument; minA: bigint | TransactionArgument; minB: bigint | TransactionArgument
}
...
export function quoteRedeem_(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), pure(tx, args.lpTokens, `u64`), pure(tx, args.minA, `u64`), pure(tx, args.minB, `u64`)
        ],
    })
}
...
export interface RedeemLiquidityArgs {
    pool: TransactionObjectInput; lpTokens: TransactionObjectInput; minA: bigint | TransactionArgument; minB: bigint | TransactionArgument
}
...
export function redeemLiquidity(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.pool), obj(tx, args.lpTokens), pure(tx, args.minA, `u64`), pure(tx, args.minB, `u64`)
        ],
    })
}
...
export function swapInner(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.quote), obj(tx, args.reserveIn), obj(tx, args.coinIn), pure(tx, args.lifetimeInAmount, `u128`), obj(tx, args.protocolFeeBalance), obj(tx, args.reserveOut), obj(tx, args.coinOut), pure(tx, args.lifetimeOutAmount, `u128`), pure(tx, args.lifetimeProtocolFee, `u64`), pure(tx, args.lifetimePoolFee, `u64`)
        ],
    })
}
...
export interface UpdateLpMetadataArgs {
    metaA: TransactionObjectInput; metaB: TransactionObjectInput; metaLp: TransactionObjectInput; treasuryLp: TransactionObjectInput
}
...
export function updateLpMetadata(
    ...
    return tx.moveCall({
        ...
        typeArguments: typeArgs,
        arguments: [
            obj(tx, args.metaA), obj(tx, args.metaB), obj(tx, args.metaLp), obj(tx, args.treasuryLp)
        ],
    })
}
