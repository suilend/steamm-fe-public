...
export interface QuoteArgs {
    amountIn: bigint | TransactionArgument; amountOut: bigint | TransactionArgument; protocolFees: bigint | TransactionArgument; poolFees: bigint | TransactionArgument; a2B: boolean | TransactionArgument
}
...
export function quote(
    ...
    return tx.moveCall({
        ...
        arguments: [
            pure(tx, args.amountIn, `u64`), pure(tx, args.amountOut, `u64`), pure(tx, args.protocolFees, `u64`), pure(tx, args.poolFees, `u64`), pure(tx, args.a2B, `bool`)
        ],
    })
}
...
export interface AddExtraFeesArgs {
    swapQuote: TransactionObjectInput; protocolFees: bigint | TransactionArgument; poolFees: bigint | TransactionArgument
}
...
export function addExtraFees(
    ...
    return tx.moveCall({
        ...
        arguments: [
            obj(tx, args.swapQuote), pure(tx, args.protocolFees, `u64`), pure(tx, args.poolFees, `u64`)
        ],
    })
}
...
export interface RedeemQuoteArgs {
    withdrawA: bigint | TransactionArgument; withdrawB: bigint | TransactionArgument; burnLp: bigint | TransactionArgument
}
...
export function redeemQuote(
    ...
    return tx.moveCall({
        ...
        arguments: [
            pure(tx, args.withdrawA, `u64`), pure(tx, args.withdrawB, `u64`), pure(tx, args.burnLp, `u64`)
        ],
    })
}
...
export interface DepositQuoteArgs {
    initialDeposit: boolean | TransactionArgument; depositA: bigint | TransactionArgument; depositB: bigint | TransactionArgument; mintLp: bigint | TransactionArgument
}
...
export function depositQuote(
    ...
    return tx.moveCall({
        ...
        arguments: [
            pure(tx, args.initialDeposit, `bool`), pure(tx, args.depositA, `u64`), pure(tx, args.depositB, `u64`), pure(tx, args.mintLp, `u64`)
        ],
    })
}
