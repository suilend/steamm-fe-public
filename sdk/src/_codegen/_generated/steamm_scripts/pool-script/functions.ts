...
export function redeemLiquidityWithProvision(
  tx: Transaction,
  typeArgs: [string, string, string, string, string, string, string],
...
export interface ToMultiSwapRouteArgs {
  bankX: TransactionObjectInput;
  bankY: TransactionObjectInput;
  lendingMarket: TransactionObjectInput;
  x2Y: boolean | TransactionArgument;
  amountIn: bigint | TransactionArgument;
