...
export class OracleQuoter implements QuoterAbi {
  ...
  public swap(tx: Transaction, args: OracleSwapArgs): TransactionResult {
    ...
    const swapResult = Codegen.OracleV1Quoter.swap(
      tx,
      this.quoterTypes(),
      callArgs,
      this.publishedAt,
  ...
  public quoteSwap(
    ...
    const quote = Codegen.OracleV1Quoter.quoteSwap(
      tx,
      this.quoterTypes(),
      callArgs,
      this.publishedAt,
  ...
  public migrateHook(
    ...
    const [coinA, coinB] = Codegen.OracleV1Quoter.migrate(
      tx,
      this.quoterTypes(),
      callArgs,
      this.publishedAt,
...
export function createOraclePool(
  ...
  return Codegen.OracleV1Quoter.new_(
    tx,
    [
      lendingMarketType,
      coinTypeA,
...
export function shareOraclePool(
  ...
  const quoterType = `${sdkOptions.packages.steamm.config!.quoterIds.omm}::omm::OracleQuoter`;
